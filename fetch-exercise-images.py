...
EXACT_WIKI_TITLES = {
    ...
    'Prone back extension':                   'Back extension',
    'Romanian Deadlift (RDL) — licht':        'Deadlift',
    'Romanian Deadlift (RDL)':                'Deadlift',
    'Romanian deadlift (licht)':              'Deadlift',
    'Kettlebell swing':                       'Kettlebell',
    'Farmers carry':                          'Loaded carry',
    'Farmers carry (boerenloop)':             'Loaded carry',
    'Box jump':                               'Plyometrics',
    'Drop jump':                              'Plyometrics',
    'Hinkelen':                               'Plyometrics',
    'Hop test (single leg)':                  'Plyometrics',
    'Sprinting':                              'Sprint (running)',
    'Sprint':                                 'Sprint (running)',
    'Looptraining':                           'Running',
    'Joggen':                                 'Jogging',
    'Jogging':                                'Jogging',
    'Wandelen met loopbanden':                'Treadmill',
    'Aquatherapie':                           'Aquatic therapy',
    'Hydrotherapie':                          'Aquatic therapy',
    'Balansplank':                            'Balance board',
    'Balance board':                          'Balance board',
    'Bosu bal':                               'BOSU',
    'Theraband':                              'Resistance band',
    'Weerstandsband':                         'Resistance band',
    'TRX':                                    'Suspension training',
    'Spitstenen lopen':                       'Walking',
    'Nordic Hamstring Curl':                  'Nordic hamstring exercise',
    'Nordic hamstring':                       'Nordic hamstring exercise',
    'Hamstring curl':                         'Hamstring curl',
    'Leg curl':                               'Hamstring curl',
    'Leg extension':                          'Knee extension',
    'Knie-extensie (machine)':                'Knee extension',
    'Shoulder shrug':                         'Shoulder shrug',
    'Scapula retractie':                      'Scapula',
    'Scapulaire stabilisatie':                'Scapula',
    'Thoracale mobilisatie':                  'Vertebral column',
    'Cervicale retractie':                    'Cervical vertebrae',
    'Cervicale extensie':                     'Cervical vertebrae',
    'Cervicale flexie':                       'Cervical vertebrae',
    'Chin tuck':                              'Cervical vertebrae',
    'Schoudermobilisatie':                    'Shoulder joint',
    'Pendel oefening':                        'Shoulder joint',
    'Codman pendulum':                        'Shoulder joint',
    'External rotation':                      'External rotation',
    'Internal rotation':                      'External rotation',
    'Externe rotatie':                        'External rotation',
    'Interne rotatie':                        'External rotation',
    'Wall angel':                             'Shoulder joint',
    'Wall angel (muur-engel)':                'Shoulder joint',
    'Enkel mobilisatie':                      'Ankle',
    'Enkel-pompen':                           'Ankle',
    'Alphabet oefening (actieve ROM)':        'Ankle',
    'Calf stretch':                           'Stretching',
    'Hamstring stretch':                      'Stretching',
    'Piriformis stretch':                     'Stretching',
    'Hip flexor stretch':                     'Stretching',
    'Heupflexor stretch (knieling)':          'Stretching',
    'Quadriceps stretch':                     'Stretching',
    'IT band stretch':                        'Stretching',
    'Knie-naar-borst stretch':                'Stretching',
    'Supine lumbar rotation stretch':         'Stretching',
    'Seated hamstring stretch':               'Stretching',
    'Piriformissstretch zijlig':              'Stretching',
