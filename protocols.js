    ...
    phases:[
      {label:'Fase 0',title:'Diagnostiek & Triage',weeks:'Week 0',
       ...
       exercises:[
         ...
         {name:'Slump test',params:[['Sens','0.84 (niet onderbouwd in dit dossier)'],['Spec','0.83']],note:'Sensitiever dan SLR. Reproductie uitstralende pijn = positief.',cat:'test'},
