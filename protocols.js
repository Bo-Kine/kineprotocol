  ...
  phases:[
    ...
    {label:'Fase 3',title:'Functionele Krachtopbouw',weeks:'Week 10–16',
     ...
     exercises:[
       ...
       {name:'Sorensen test / rugextensie prone',params:[['Hold','tot max (doel ≥ 60 sec)'],['Sets','2–3'],['Freq','2×/week']],note:'Buiklig op tafelrand, benen gefixeerd. Houd torso horizontaal. Meet uithoudingsvermogen lumbale extensoren (Biering-Sørensen, 1984). Goede rugspieruithouding voorkwam in dat cohort een eerste episode rugpijn bij mannen; als revalidatiedrempel is de test een praktijkafspraak.',cat:'kracht'},
