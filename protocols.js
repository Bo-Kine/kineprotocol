...
const BESCHRIJVING = {
  ...
  lh:{
    kenmerken:'<strong>Radiculopathie</strong> gekenmerkt door dermatomale pijn, tintelingen en/of krachtverlies in het been. L4: anteromediale onderbeen + kniepees-reflex; <strong>L5</strong>: dorsale voet, grote teen + extensiezwakte; <strong>S1</strong>: laterale voetrand, hak + achillesreflex. Positieve Lasègue < 60° heeft sensitiviteit 91% voor radiculopathie (van der Windt et al., 2010 — Ann Fam Med). Ernstige hernia kan <strong>cauda equina syndroom</strong> veroorzaken (blaas-/darmstoornissen, perianale hypo-esthesie) — urgentie voor chirurgie. MRI toont discusherniatie met compressie van de desbetreffende zenuwwortel.',
    oorzaken:'<strong>Discusdegeneratie</strong> met afname van de waterbindingscapaciteit van de nucleus pulposus leidt tot verminderde schokabsorptie en verhoogde annulusbelasting. <strong>Herniatie</strong> treedt op bij plotse intradiscale drukstijging (Valsalva, tillen met gefixeerde wervelkolom). L4-L5 en L5-S1 zijn verantwoordelijk voor <strong>95% van lumbale herniaties</strong>. Risicofactoren zijn: leeftijd 35–55 jaar, mannelijk geslacht, zwaar beroep (trillingen, buigen+draaien), roken (verminderde discusperfusie) en genetische discusdegeneratie (Battié et al., 2004 — Spine). <strong>90% resolveert spontaan</strong> binnen 12 weken zonder operatieve ingreep (Weber, 1983 — Spine).'
  },

  rc:{
    kenmerken:'<strong>Pijnboog 60–120°</strong> bij abductie (impingement-fenomeen), nachtpijn in zijlig op aangedane zijde, zwakte bij abductie en/of exorotatie. <strong>Neer-teken</strong> (passieve elevatie in pronatie — subacromiale bursitis), <strong>Hawkins-Kennedy</strong> (elevatie 90° + interne rotatie — supraspinatusimpingement): sensitiviteit 79%, specificiteit 66% (Hegedus et al., 2012 — BJSM). Partieelscheuring: kracht doorgaans bewaard; <strong>complete ruptuur</strong>: drop-arm test positief, zwakte abductie > 30°. Echografie heeft accuraatheid van 84% voor partiële en complete rupturen van de rotatorenmanchet.',
  ...
  pt:{
    kenmerken:'<strong>Lokale pijn infrapatellair</strong> aan de patellapeesaanhechting, reproduceerbaar bij éénbenige squat en VISA-P < 80/100. Pijn bij belasting (springen, hardlopen, trap), typisch afwezig in rust en ochtend. Klinisch: <strong>punctapijn bij palpatie</strong> van het infrapatellair punt, soms echografische verdikking en verminderde peesvascularisatie. Symptomen reageren paradoxaal positief op isometrische peesinhibitie (Rio et al., 2015). <strong>Gradatie</strong>: graad I (alleen na training), II (tijdens en na), III (permanent, sport onmogelijk), IV (volledig functioneel verlies — operatieve overweging).',
    oorzaken:'<strong>Reactieve tendinopathie</strong> door plotse stijging van tensielbelasting op de pees, typisch bij "springerssporten" (volleybal, basketbal, turnen). Pathologisch leidt herhaalde overbelasting tot <strong>disorganisatie van collageen, neovascularisatie en nociceptoringroei</strong> zonder echte inflammatie (Cook & Purdam, 2009 — BJSM). Risicofactoren: mannelijk geslacht, leeftijd 20–40 jaar, hoge trainingsbelasting, verminderde quadriceps- en hamstringflexibiliteit, beenlengteverschil en slechte landingstechniek. <strong>Trainingsfouten</strong> (volume + intensiteit stijging > 10%/week) zijn de meest directe trigger voor symptoomontwikkeling.'
  },
  ...
  at:{
    kenmerken:'<strong>Pijn en stijfheid</strong> in het achillespeesgebied, typisch erger bij opstaan en na rust ("startstijfheid"), verbetert na opwarming maar keert terug na belasting. VISA-A score < 80/100. <strong>Midportion AT</strong> (2–6 cm boven insertie): fusiforme zwelling, crepitaties, positieve arc-test; <strong>insertionele AT</strong> (aan calcaneus): haakspijnboog, positieve palpatie bij enthese. Royal London Hospital Test (dorsaalflexie met gebogen knie) reproduceert pijn bij insertionele AT. <strong>Echografische verdikking</strong> > 6 mm en intra-tendineuze hypo-echogeniciteit bevestigen de diagnose.',
    oorzaken:'<strong>Reactief-degeneratieve tendinopathie</strong> door cumulatieve overbelasting van het gastrocnemius-soleuscomplex. Directe trigger: plotse stijging loopvolume (> 10%/week), heuveltraining, harde ondergrond of schoeiselwisseling. Pathologisch: <strong>collageendisorganisatie, neovascularisatie en sympathische nociceptorproliferatie</strong> in het para-tenon (Alfredson & Lorentzon, 2000 — Sports Med). Risicofactoren: mannelijk geslacht, leeftijd > 35, overgewicht, fluoroquinolon-antibiotica (ruptuurrisico ×3), diabetes, genu valgum en overpronatie. <strong>Insertionele AT</strong> heeft andere pathomechaniek: compressie van de enthese door pronatie en retocalcaneale botimpingement (Haglund-deformiteit).'
  },

  bureau:{
    kenmerken:'<strong>Cervicogene hoofdpijn</strong> (eenzijdig, occipitaal → temporaal/frontaal), nekpijn bij rotatiebeperking, schouderspanning (trapezius superior), thoracale kyfoseversterking en sub-occipitale hypertoniciteit. Kenmerkend: klachten die toenemen naarmate de werkdag vordert en verminderen bij beweging. <strong>Cervicocraniaal syndroom</strong> met C1-C3 pijnreferentie (Watson & Trott, 1993 — Cephalalgia). <strong>Thoracic outlet syndroom</strong> (TOS) kan optreden bij chronische protractiehouding van de schouder. Tintelingen in hand en tinnitus zijn mogelijke bijkomende symptomen bij ernstig cervicogene component.',
    oorzaken:'<strong>Statische houdingsbelasting</strong> bij > 6 uur computerschermwerk zonder onderbreken leidt tot <strong>ischemische spierspanning</strong> in de sub-occipitale en cervicale spieren via lage-drempel-motorunit-rekrutering (Cinderella-hypothese: Type I vezels gaan nooit volledig "off-duty"). <strong>Neurale sensitisatie</strong> van trigeminale en C2-C3 dermatomen bij chronische nociceptie versterkt het pijnpatroon. Ergonomische risicofactoren: schermhoogte buiten ooghoogte, toetsenbord te ver, stoel zonder armleuningen. Psychosociale factoren (werkdruk, controleverlies) verhogen spierspanning via limbisch-musculaire feedback. <strong>Slaapkwaliteitsreductie</strong> verlaagt de centrale pijndrempel en vertraagt herstel.'
  },
  ...
  faz:{
    kenmerken:'<strong>Lumbale pijn bij extensie, lateraalflexie en rotatie</strong> naar de aangedane zijde, verlichting bij vooroverbuigen. Typisch: ochtendstijfheid > 30 min, bilaterale of unilaterale lumbale pijn met uitstraling naar bil en bovenbeen (<strong>pseudoradiculair patroon</strong>, doorgaans niet onder de knie). <strong>Kemp-test</strong> (extensie + rotatie + lateraalflexie ipsilateraal) is reproducerend. Röntgen/CT toont facetversmalling, osteofyten en subchondrale sclerose. <strong>SPECT-scan</strong> is het meest sensitief voor actieve facetpijn. Diagnostische facetblokkade (> 80% pijnreductie) bevestigt de diagnose.',
    oorzaken:'Degeneratie van de <strong>zygapofysaire gewrichten</strong> (synoviaalgewricht met hyalien kraakbeen) door cumulatieve mechanische overbelasting en veroudering. Discusdegeneratie verhoogt de facetbelasting door hogere compressiekrachten bij discushoogteverlies. <strong>Spondylolisthesis</strong> en facethypertrofie kunnen spinaalstenose veroorzaken met claudicatio als bijkomend symptoom. Risicofactoren: leeftijd > 50 jaar, obesitas, <strong>repetitieve extensiebelasting</strong> (bouwvakkers, gymnasten), genetische predispositie voor vroege artrose. De rijke nociceptieve innervatie van het facetkapsel (mediale tak van ramus posterior) verklaart zowel de lokale als gerefereerde pijn.'
  },

  sup:{
    kenmerken:'<strong>Subacromiale pijnboog</strong> bij abductie 60–120°, nachtpijn in zijlig, zwakte abductie en impingement-tekenen. <strong>Neer-test</strong> (passieve elevatie in pronatie — sensitiviteit 79%), <strong>Hawkins-Kennedy</strong> (IR bij 90° elevatie — sensitiviteit 74%), <strong>lege-blik-test (empty can)</strong> specifiek voor supraspinatus (sensitiviteit 69%, specificiteit 66%). Echografisch: hypo-echogeniciteit, peesverbreding of defect in de supraspinatuspees. Differentiatie van bursitis subacromialis: steroïdinjectie-effect en echografische vloeistofaccumulatie in de subacromiale ruimte. MRI-arthrogram voor definitieve classificatie bij chirurgische overweging.',
    oorzaken:'<strong>Outlet-impingement</strong>: de supraspinatuspees wordt gecomprimeerd tussen acromion en humerushoofd in de subacromiale ruimte (type II–III acromionmorfologie, os acromiale, AC-gewrichtsosteofyten). <strong>Hypovasculaire zone</strong>: de kritische zone 1 cm proximaal van de insertie is relatief avasculair — degeneratie wordt bevorderd door belasting zonder adequate doorbloeding. Repetitieve overhead-bewegingen verhogen de subacromiale druk chronisch. <strong>Scapulaire dyskinesie</strong> (abnormale scapulabeweging) vermindert de acromio-humerale afstand en faciliteert impingement. Progressie verloopt van tendinose → partiële scheuring → complete ruptuur wanneer onbehandeld.'
  },

  fbl:{
    kenmerken:'Post-interventie protocol na <strong>lumbale facetblokkade</strong> (intra-articulaire corticosteroïdinjectie of mediale-tak-blokkade) of <strong>radiofrequente denervatie (RFD)</strong>. Patiënt heeft diagnostisch bewezen facetpijn (> 80% pijnreductie na blokkade). Post-RFD: 3–6 weken herstelperiode terwijl de mediale zenuwtak regenereert. Pre-interventie aanwezige symptomen: extensiegerelateerde lumbale pijn, uitstraling naar bil/bovenbeen zonder neurologische uitval. <strong>VAS-daling na injectie</strong> vormt het uitgangswaarde voor revalidatieprogressie in het pijnvrije venster.',
    oorzaken:'Dezelfde etiologie als facetartrose: <strong>zygapofysaire gewrichtsdegeneratie</strong> met nociceptieve sensitisatie van de mediale tak (ramus posterior medialis L1-L5 innerveert de facetgewrichten). Indicatie voor blokkade: <strong>onvoldoende conservatieve behandelrespons</strong> na 3+ maanden, klinisch facetpijnsyndroom (positieve Kemp-test, afwezigheid radiculopathie). RFD coaguleert de mediale tak en onderbreekt de nociceptieve transmissie voor gemiddeld 9–18 maanden. <strong>Revalidatie benut het pijnvrije venster</strong> na interventie voor progressieve belasting die voordien door pijn onmogelijk was. Herhaling van RFD is mogelijk na herbinnervatie.'
  },
