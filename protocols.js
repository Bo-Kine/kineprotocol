...
const protocols = {
  ...
  tka:{id:'tka',title:'Totale Knieprothese',subtitle:'TKA revalidatie inclusief prehabilitatie, ERAS-protocol en sporthervatting',color:'#a78bfa',
    phases:[
      {label:'Preop + Dag 0–3',title:'Preoperatief & Acute Zorg',weeks:'Preop + Dag 0–3',
       evidence:'<strong>Prehabilitatie</strong> (Jakobsen et al., 2014) en <strong>mobilisatie op dag 0</strong> binnen een ERAS-traject (Kehlet &amp; Thienpont, 2013): <em>beide publicaties zijn in dit dossier niet opgehaald; de aanpak zelf is in Vlaanderen gangbare praktijk.</em>',
      ...
      {label:'Week 1–2',title:'Vroeg Postoperatief',weeks:'Week 1–2',
       evidence:'<strong>Ziekenhuisduur van 2 tot 3 dagen</strong> bij ERAS: <em>klinische praktijk, in dit dossier niet nagekeken.</em> <strong>Cryotherapie — let op de conclusie van de bron.</strong> In elf gerandomiseerde trials en één gecontroleerde trial, samen 809 deelnemers, werd bewijs van <strong>zeer lage kwaliteit</strong> gevonden voor minder bloedverlies (10 trials, 666 deelnemers) en voor minder pijn <strong>na 48 uur</strong> (4 trials, 322 deelnemers; 1,32 punten op tien) — maar niet na 24 of 72 uur, en beide effecten mogelijk niet klinisch relevant. <em>Volledigheidshalve ook de gunstige kant: bij ontslag werd 11,4° meer flexie gezien, op bewijs van lage kwaliteit.</em> De auteurs besluiten dat de mogelijke voordelen <strong>te klein kunnen zijn om het gebruik te rechtvaardigen</strong>, afgewogen tegen ongemak en kosten (Adie et al., 2012 — Cochrane). <em>De app schreef simpelweg dat cryotherapie de pijn reduceert.</em> <strong>CPM wordt niet aanbevolen:</strong> geen klinisch relevante effecten op flexie (2 graden), pijn, functie of levenskwaliteit in 24 studies met 1445 deelnemers. <em>Wel een nuance die ontbrak: CPM verlaagt mogelijk het risico op manipulatie onder narcose (7,2% naar 1,6%; risicoratio 0,3), al is dat bewijs van zeer lage kwaliteit</em> (Harvey et al., 2014 — Cochrane).',
       ...
       exercises:[
         ...
         {name:'Cryotherapie post-sessie',params:[['Duur','15–20 min'],['Timing','na elke sessie']],note:'IJszak met doek, niet op wond. Let op: de Cochrane-review van Adie et al. (2012) besluit dat de voordelen van cryotherapie te klein kunnen zijn om routinematig gebruik te rechtvaardigen — zet ze in bij pijn, niet standaard na elke sessie.',cat:'manueel'}],
       criteria_go:['Extensie 0°','Flexie ≥ 90°','Lopen OK','Trapvaardigheid OK'],
       criteria_stop:['Flexie < 80° na 2 wkn → MUA-overleg (drempel is praktijkafspraak, niet onderbouwd)'],
       redflags:['MUA-indicatie bij flexie < 90° na week 6–8 (praktijkafspraak)','Optimale timing: voor week 12 (praktijkafspraak; Harvey et al. 2014 doet geen uitspraak over drempel of timing)']},
      {label:'Week 2–6',title:'Subacuut Herstel',weeks:'Week 2–6',
       evidence:'<strong>Oefentherapie na ontslag — de richting van het bewijs klopte niet.</strong> De meta-analyse van 18 studies met 1739 patiënten vond <strong>géén verschil</strong> tussen ambulante en thuisbehandeling voor functie of pijn, en op korte termijn zelfs een voordeel <strong>vóór thuisbehandeling</strong> wat de flexie-mobiliteit betreft (Artz et al., 2015 — BMC Musculoskelet Disord). <em>De eerdere bewering dat ambulante kinesitherapie driemaal per week superieur is, keert die bevinding om en is geschrapt.</em> Wat de review wél aantoont: tegenover minimale kinesitherapie verbetert oefentherapie de functie (SMD -0,37; 95% BI -0,62 tot -0,12) en de pijn (SMD -0,45; -0,85 tot -0,06) op 3 tot 4 maanden — <em>maar bij het samenvoegen van enkel de hoogwaardige studies bleef de winst tot zes maanden zichtbaar en werden daarbuiten géén langetermijneffecten gevonden — met één uitzondering: in één studie gaf een loopvaardigheidsprogramma wel langetermijnwinst op de loopprestatie. De conclusie berust op een klein aantal onvoldoende gepowerde studies.</em> <strong>Aquatherapie</strong> gaf in die review geen ander resultaat dan gewone oefentherapie; de start vanaf week 3 tot 4 is een <em>praktijkafspraak.</em>',
       goals:['Flexie ≥ 110°','Lopen zonder hulpmiddel','Zelfstandige ADL','Fietsen 20 min'],
       exercises:[
         {name:'Stationaire fiets',params:[['Duur','15–25 min'],['Freq','dagelijks']],note:'Verlaag zadel progressief. Vereist ongeveer 105° flexie — praktijkdrempel, niet onderbouwd.',cat:'cardio'},
         {name:'Mini-squat (0–60°)',params:[['Reps','12–15'],['Sets','3']],note:'Progressief dieper.',cat:'kracht'},
         {name:'Aquatherapie',params:[['Start','week 3–4'],['Duur','30–45 min'],['Freq','2×/week']],note:'Hydrostatische druk zou het oedeem verminderen — in dit dossier niet nagekeken.',cat:'cardio'},
       ...
       criteria_go:['ROM 0–110°','TUG < 12 sec','5× STS zonder armen','Trappen voet-voor-voet — alle vier praktijkafspraken, niet onderbouwd in dit dossier'],
       criteria_stop:['ROM < 100° na 6 wkn → chirurg'],redflags:[]},
      {label:'Week 6–12',title:'Functioneel Herstel',weeks:'Week 6–12',
       evidence:'<strong>Progressieve weerstandstraining</strong> is klinisch verdedigbaar, <em>maar de aangehaalde meta-analyse (Artz et al., 2015) evalueert nergens weerstandsintensiteit — de dosering van 70 tot 80% 1RM komt daar niet uit en is een praktijkafspraak.</em> Wat die review wel meldt: toevoeging van balans- of fietsonderdelen aan algemene oefentherapie gaf géén verschil in uitkomst.',
       goals:['Flexie ≥ 120°','Trappen zonder leuning','6MWT ≥ 300m','Quad LSI ≥ 70–75%'],
       exercises:[
         {name:'Progressieve weerstandstraining',params:[['Reps','8–12'],['Sets','3–4'],['Belasting','70–80% 1RM (praktijkafspraak, niet onderbouwd)']],note:'Leg press, knie-extensie, squat, RDL. Wekelijks verhogen.',cat:'kracht'},
         {name:'Fietsen buiten',params:[['Duur','20–45 min'],['Freq','3–5×/week']],note:'Toegestaan zodra de flexie dat toelaat; de drempel van 105° is een praktijkafspraak.',cat:'cardio'},
         {name:'Nordic walking',params:[['Duur','20–40 min'],['Freq','3–4×/week']],note:'Wordt gebruikt om de kniebelasting te verlagen; de eerder vermelde reductie van 25% had geen bron en is geschrapt.',cat:'kracht'},
       ...
       criteria_go:['ROM ≥ 120°','6MWT ≥ 300m','Quad LSI ≥ 70%','TUG < 10 sec — alle vier praktijkafspraken, niet onderbouwd in dit dossier'],
      ...
      {label:'Mnd 3–6+',title:'Activiteit & Langetermijn',weeks:'Maand 3–6+',
       evidence:'<strong>Krachttekort tot 2 jaar</strong> zonder training (Mizner et al., 2011) en <strong>chronische pijn bij 15 tot 20%</strong>: <em>beide in dit dossier niet opgehaald. Wat wél geverifieerd is en hier van belang: de meta-analyse van Artz et al. (2015) vond op één loopvaardigheidsstudie na géén langetermijneffect van oefentherapie na knieprothese — dat pleit voor onderhoudstraining, maar het is geen aangetoond effect.</em>',
    ...
    refs:'Artz N et al. (2015) — Effectiveness of physiotherapy exercise following total knee replacement: systematic review and meta-analysis. BMC Musculoskelet Disord 16:15; GEEN verschil ambulant tegenover thuis, geen langetermijneffect. | Adie S et al. (2012) — Cryotherapy following total knee replacement. Cochrane Database Syst Rev (9):CD007911; bewijs van zeer lage kwaliteit, voordelen mogelijk te klein om gebruik te rechtvaardigen. | Harvey LA et al. (2014) — Continuous passive motion following total knee arthroplasty. Cochrane Database Syst Rev 2014(2):CD004260; geen klinisch relevante effecten, wel mogelijk minder manipulatie onder narcose. | Jakobsen TL et al. (2014), Kehlet H &amp; Thienpont E (2013) en Mizner RL et al. (2011) — in dit dossier niet opgehaald.'},
  ...
  rc:{id:'rc',title:'Rotatorenmanchet',subtitle:'Conservatief en postoperatief protocol voor rotatorenmanchet letsel (partieel / volledig / post-OK)',color:'#f43f5e',
    phases:[
      {label:'Fase 0',title:'Diagnostiek & Classificatie',weeks:'Vóór behandelstart',
       ...
       exercises:[
         {name:'Neer impingement test',params:[['Sens','0.72 (Hegedus 2012)'],['Spec','0.60 (Hegedus 2012)']],note:'Passieve elevatie schouder. Ook in combinatie met andere testen blijft de winst volgens die meta-analyse marginaal.',cat:'test'},
         {name:'Hawkins-Kennedy test',params:[['Sens','0.79 (Hegedus 2012)'],['Spec','0.59 (Hegedus 2012)']],note:'Elleboog + schouder 90°, interne rotatie. Iets sensitiever dan Neer, maar even weinig specifiek.',cat:'test'},
         {name:'Empty can test (supraspinatus)',params:[['Sens','0.69 (niet onderbouwd in dit dossier)'],['Spec','0.66 (niet onderbouwd in dit dossier)']],note:'Schouder 90° abductie, 30° horizontaal, interne rotatie. Weerstand op voorarm.',cat:'test'},
         {name:'External rotation lag sign (infraspinatus)',params:[['Sens','0.70 (niet onderbouwd in dit dossier)'],['Spec','0.97 (niet onderbouwd in dit dossier)']],note:'Beide cijfers zijn in dit dossier niet nagekeken. Arm valt terug uit maximale ER = positief.',cat:'test'},
         {name:'Lift-off test (subscapularis)',params:[['Sens','0.62 (niet onderbouwd in dit dossier)'],['Spec','0.97 (niet onderbouwd in dit dossier)']],note:'Hand op lage rug, duwt weg van rug. Kan niet = subscapularis ruptuur.',cat:'test'},
      ...
      {label:'Fase 2',title:'Actieve ROM & Scapulaire Controle',weeks:'Week 3–8 (cons.) / Week 4–10 (post-OK)',
       ...
       exercises:[
         ...
         {name:'Serratus anterior — wall slide',params:[['Reps','10–15'],['Sets','3'],['Positie','beide handen op muur, scapula protractie']],note:'"Duw de muur weg" met scapula. De wall slide werd door Cools et al. (2007) niet onderzocht, en in die studie haalde geen enkele oefening het vooropgestelde criterium voor de trapezius-serratusverhouding.',cat:'stabiliteit'},
         ...
         {name:'Wand push-up (gesloten keten)',params:[['Reps','10–15'],['Sets','3'],['Progressie','verder van muur → vloer']],note:'Veilig post-OK zodra actieve beweging toegestaan. De EMG-uitspraak over serratusactiviteit is in dit dossier niet onderbouwd.',cat:'stabiliteit'},
      ...
      {label:'Fase 3',title:'Krachtontwikkeling RM',weeks:'Week 8–16 (cons.) / Week 10–20 (post-OK)',
       ...
       goals:['RM-kracht LSI ≥ 80%','ER/IR ratio ≥ 0.66 (praktijkafspraak, niet uit Cools 2007)','Volledige actieve ROM','Overhead activiteiten pijnvrij','DASH < 20'],
       exercises:[
         {name:'Side-lying ER (eccentrisch accent)',params:[['Reps','8–12'],['Sets','3–4'],['Tempo','2-0-4']],note:'Infraspinatus + teres minor. 4 sec eccentrisch zakken. De peesadaptatie werd aan de achillespees onderzocht (Beyer 2015), niet aan de schouder.',cat:'kracht'},
         {name:'Full can (scapular plane abductie)',params:[['Reps','10–12'],['Sets','3'],['ROM','0–120°'],['Belasting','60–75% 1RM (niet onderbouwd in dit dossier)']],note:'30° voor frontale vlak, duim omhoog. Lagere subacromiale compressie dan empty can — klinische redenering.',cat:'kracht'},
         ...
         {name:'Push-up plus',params:[['Reps','10–15'],['Sets','3'],['Progressie','knieën → tenen → instabiel']],note:'Eindfase push-up: extra protractie. Dat dit de hoogste serratusactiviteit geeft, is in dit dossier niet onderbouwd.',cat:'stabiliteit'},
       ...
       criteria_go:['RM-kracht LSI ≥ 80%','ER/IR ratio ≥ 0.66 (praktijkafspraak, niet uit Cools 2007)','Volledige actieve ROM','DASH < 20','Overhead pijnvrij'],
      ...
      {label:'Fase 4',title:'Functioneel & Sportspecifiek',weeks:'Week 12–20+ (cons.) / Week 16–24+ (post-OK)',
       ...
       exercises:[
         {name:'Interval Throwing Program (overhead-sporters)',params:[['Start','fase 1: 45 voet'],['Progressie','afstand + intensiteit'],['Freq','om de dag']],note:'Gangbaar schema: 45 → 60 → 90 → 120 voet, elke fase 2× pijnvrij voor progressie. Het ASMI-protocol is in dit dossier niet opgehaald.',cat:'neuro'},
         ...
         {name:'Onderhoudsprogramma (post-RTS)',params:[['Freq','2×/week'],['Vb','ER-band, prone Y, push-up plus']],note:'Levenslang onderhoud. Dat het recidief frequent is bij stoppen, is in dit dossier niet onderbouwd.',cat:'kracht'}],
       criteria_go:['RM-kracht LSI ≥ 90%','Interval throwing program volledig','WORC/WOSI ≥ 80%','Pijn NRS ≤ 1/10 bij sportactiviteit'],
       criteria_stop:['Pijn bij sport > NRS 3 → fase 3 consolideren','Post-OK grote ruptuur: overhead sport uitstellen tot ≥ 9 maanden (praktijkafspraak — Van der Meijden 2012 stelt net dat de timing niet door bewijs gestuurd is)'],
      ...
      {label:'Fase 5',title:'Preventie & Langetermijn',weeks:'Mnd 4–6+',
       ...
       exercises:[
         ...
         {name:'Ergonomische werkhouding',params:[['Vb','schermhoogte, muis-positie, tilhouding']],note:'Armen niet boven schouderhoogte. Beeldscherm op ooghoogte. De grens van 23 kg is in dit dossier niet onderbouwd; van Rijn et al. (2010) noemt tillen boven 20 kg meer dan tienmaal per dag als risicofactor, geen tillimiet.',cat:'manueel'},
         {name:'Slaaphouding advies',params:[['Advies','niet op aangedane zijde slapen']],note:'Ruglig met kussen onder de arm wordt doorgaans als beste positie aangeraden. Het compressie- en ischemiemechanisme en de duur van 6–8 uur zijn klinische redenering, in dit dossier niet nagekeken.',cat:'manueel'}],
    ...
    refs:'Hegedus et al. (2012) — Physical examination tests for shoulder pathology: BJSM meta-analyse. | Kukkonen et al. (2015) — Conservative vs surgical for RC tears: RCT. J Bone Joint Surg Am. | Kibler et al. (2013) — Clinical implications of scapular dyskinesis in shoulder injury. BJSM. | Cools et al. (2007) — Rehabilitation of scapular muscle balance. Am J Sports Med. | Rio et al. (2015) — Isometric contractions reduce pain in tendinopathy. BJSM. | Beyer et al. (2015) — Heavy slow resistance vs eccentric training for tendinopathy in ACHILLESpees. Am J Sports Med. | Van der Meijden et al. (2012) — Rehabilitation after arthroscopic RC repair. Int J Sports Phys Ther. | Bernhardsson et al. (2011) — Excentrische manchettraining bij subacromiaal impingement: single-subject-opzet bij tien patienten. Clin Rehabil. | Burkhart et al. (2003) — The disabled throwing shoulder part III: narratieve review, geen uitkomstgegevens. Arthroscopy. | van Rijn et al. (2010) — Werkgerelateerde RISICOFACTOREN voor schouderaandoeningen; geen interventies, geen manchetscheuren. Scand J Work Environ Health.'},
  ...
  gmt:{id:'gmt',title:'Gluteus Med./Min. Tendinopathie',subtitle:'Greater Trochanteric Pain Syndrome — laterale heuppijn, load management, progressieve abductorkracht',color:'#14b8a6',icon:'🦴',
    phases:[
      {label:'Fase 1',title:'Pijnmanagement & Educatie',weeks:'Weken 0–2',
       evidence:'<strong>Greater Trochanteric Pain Syndrome (GTPS)</strong> geldt nu als gluteale tendinopathie en niet meer als trochanter-bursitis; de aandoening komt vooral voor bij postmenopauzale vrouwen en weegt zwaar op de levenskwaliteit (Grimaldi &amp; Fearon, 2015 — JOSPT). <em>Dat is een klinisch commentaar; de auteurs schrijven zelf dat studies van hoge kwaliteit nog ontbreken en dat hun aanbevelingen mede op eigen ervaring berusten.</em> <strong>Compressie</strong> bij heup-adductieposities als pijndriver en het vermijden van laterale rek zijn <em>klinische redenering langs die lijn.</em> <strong>Isometrische oefening</strong> werd onderzocht aan de <strong>patellapees</strong> (Rio et al., 2015); <em>overdracht naar de heup is klinische redenering.</em> <strong>Educatie plus oefening:</strong> in een trial bij 204 mensen met MRI-bevestigde gluteale tendinopathie meldde na acht weken <strong>51 van 66</strong> in de oefengroep verbetering, tegenover 38 van 65 na injectie en 20 van 68 bij afwachten — een risicoverschil van 49,1% tegenover afwachten (number needed to treat <strong>2,0</strong>) en 19,9% tegenover injectie (Mellor et al., 2018 — BMJ).',
      ...
      {label:'Fase 2',title:'Isotone Opbouw',weeks:'Weken 2–8',
       evidence:'<strong>Heupabductorzwakte is aangetoond, de behandelclaim niet.</strong> De aangehaalde studie is een <strong>case-controlstudie zonder enige behandeling</strong>: mensen met eenzijdige gluteale tendinopathie bleken <strong>beiderzijds</strong> zwakker dan gezonde controles — 32% aan de symptomatische en 23% aan de asymptomatische zijde — met 11% verschil tussen beide eigen heupen (Allison et al., 2016 — MSSE). <em>De auteurs stellen uitdrukkelijk dat niet duidelijk is of die zwakte aan de aandoening voorafgaat dan wel er een gevolg van is. Dat progressieve isotone abductietraining de pijn vermindert en het functioneren verbetert, staat er niet in en is geschrapt.</em> <strong>Wat de zwakte wel rechtvaardigt:</strong> abductorkracht meenemen in het behandelplan — dat is de conclusie die de auteurs zelf trekken. De opbouw van zijligging naar belast staan, het vermijden van maximale adductie en de pijnregel van 2/10 na 24 uur blijven <em>klinische richtlijn.</em>',
      ...
      {label:'Fase 3',title:'Krachtontwikkeling',weeks:'Weken 8–16',
       evidence:'<strong>Progressieve weerstandstraining</strong> is een verdedigbare keuze, <em>maar de aangehaalde trial bevat géén rekarm: Mellor et al. (2018) vergeleek educatie plus oefening met een corticosteroïdinjectie en met afwachten. Een vergelijking van hoogbelaste krachttraining met rekoefeningen kan daar niet uit komen en is geschrapt.</em> Wat die trial wel toont, is dat het <strong>volledige programma van 14 sessies over acht weken</strong> beter werkte dan beide alternatieven. <em>De drempel van 80% voor de limb symmetry index is een praktijkafspraak; Ganderton et al. (2018) is in dit dossier niet opgehaald.</em>',
      ...
      {label:'Fase 4',title:'Functionele Terugkeer & RTS',weeks:'Weken 16–24+',
       evidence:'<strong>Functionele terugkeer</strong> met progressieve blootstelling en monitoring van de pijnrespons is <em>klinische richtlijn.</em> <em>De drempel van 90% voor de limb symmetry index staat niet in Grimaldi &amp; Fearon (2015) — dat is een klinisch commentaar zonder die maat — en is als praktijkafspraak gelabeld.</em> <strong>Zelfmanagement en een flare-up-protocol</strong> zijn <em>klinische richtlijn.</em> <em>Belangrijke nuance voor het gesprek met de patiënt: in de trial van Mellor et al. (2018) was educatie plus oefening op 52 weken wél beter dan een injectie op de globale beoordeling, maar was er op dat moment géén verschil meer in pijnintensiteit (-0,26; 95% BI -1,06 tot 0,55).</em>',
    ...
    refs:'Mellor R et al. (2018) — Education plus exercise versus corticosteroid injection versus wait and see for gluteal tendinopathy. BMJ 361:k1662; op 52 weken beter op globale beoordeling maar GEEN verschil in pijn tegenover injectie; geen rekarm in de trial. | Allison K et al. (2016) — Hip abductor muscle weakness in individuals with gluteal tendinopathy. Med Sci Sports Exerc 48(3):346-52; CASE-CONTROLSTUDIE zonder behandeling, beiderzijdse zwakte, oorzaak of gevolg onduidelijk. | Grimaldi A &amp; Fearon A (2015) — Gluteal tendinopathy: integrating pathomechanics and clinical features. J Orthop Sports Phys Ther 45(11):910-22; klinisch commentaar op basis van beperkt bewijs en eigen ervaring, geen LSI-drempel. | Rio E et al. (2015) — isometrie bij PATELLApeestendinopathie, niet aan de heup onderzocht. | Ganderton C et al. (2018) — in dit dossier niet opgehaald.'},
  ...
  enkel:{id:'enkel',title:'Enkeldistorsie',subtitle:'Laterale enkeldistorsie — graad I, II en III (ATFL/CFL/PTFL) + chronische instabiliteit',color:'#f59e0b',
    phases:[
      {label:'Fase 0',title:'Diagnostiek & Graadclassificatie',weeks:'Dag 0–3 na letsel',
       evidence:'<strong>Epidemiologie.</strong> De aangehaalde meta-analyse van 181 prospectieve studies is <strong>zuiver epidemiologisch</strong>: ze vond een hogere incidentie bij vrouwen dan mannen (13,6 tegenover 6,94 per 1000 blootstellingen), bij kinderen dan adolescenten en bij adolescenten dan volwassenen, met zaal- en veldsporten als hoogste risico, en bevestigde dat de laterale distorsie het meest voorkomende type is (Doherty et al., 2014 — Sports Med). <em>De eerder vermelde cijfers &quot;85% van alle enkeldistorsies&quot; en &quot;ATFL-betrokkenheid in 70–85%&quot; staan er niet in en zijn geschrapt.</em> <strong>Graadclassificatie</strong> stuurt het beleid: Graad I (rek ATFL, geen laxiteit), Graad II (partiële ruptuur ATFL + evt CFL, lichte laxiteit), Graad III (volledige ruptuur ATFL + CFL, evt PTFL, duidelijke laxiteit) — <em>klinische indeling.</em> <strong>Ottawa Ankle Rules:</strong> in 27 gepoolde studies met 15 581 patiënten bedroeg de negatieve likelihood ratio 0,08 (95% BI 0,03–0,18); bij een fractuurprevalentie van 15% blijft dan minder dan 1,4% kans op een werkelijke fractuur. De auteurs spreken van een sensitiviteit van <strong>bijna 100%</strong> met een matige specificiteit, en van 30 tot 40% minder onnodige radiografieën (Bachmann et al., 2003 — BMJ). <em>Het eerder vermelde bereik van 96–99% staat er niet in.</em> <strong>Anterior Drawer Test</strong> (&gt; 3 mm asymmetrie, sensitiviteit 0.71 / specificiteit 0.33 acuut) en <strong>Talar Tilt</strong> (&gt; 10°): <em>cijfers in dit dossier niet nagekeken.</em> <strong>PEACE</strong> (Dubois &amp; Esculier, BJSM 2019) vervangt RICE in de acute fase. <strong>Syndesmoseletsel</strong> is een aparte entiteit met langere revalidatie — <em>klinische richtlijn.</em>',
       ...
       exercises:[
         {name:'Ottawa Ankle Rules screenen',params:[['Sens','bijna 100% (Bachmann 2003 poolt negatieve likelihood ratio 0,08; het eerder vermelde bereik 96–99% staat er niet in)'],['Test','palpatie malleoli + naviculare + 5e metatarsaal']],note:'Drukpijn op posterieure rand/tip laterale of mediale malleolus? Pijn over naviculare of basis 5e metatarsaal? Onvermogen belasting? → Rx verplicht. Negatief = geen fractuur → start revalidatie.',cat:'test'},
      ...
      {label:'Fase 1',title:'Acute Fase — PEACE + Vroege Mobilisatie',weeks:'Dag 0–7 (G-I: 3–5d · G-II: 5–7d · G-III: 7–10d)',
       evidence:'<strong>Vroege functionele behandeling</strong> is superieur aan immobilisatie bij Graad I en II (Kerkhoffs et al., Cochrane 2002) — <em>de Cochrane-review is in dit dossier niet opgehaald.</em> <strong>PEACE &amp; LOVE</strong> vervangt RICE (Dubois &amp; Esculier, BJSM 2019); dat ijs en NSAID&#39;s de noodzakelijke inflammatie onderdrukken is de redenering van dat editoriaal, <em>geen trialuitkomst.</em> <strong>Graad III:</strong> conservatief gelijkwaardig aan chirurgie bij de meeste patiënten (Kerkhoffs et al., 2007) — <em>niet opgehaald.</em> Bij de jonge topsporter met aanhoudende instabiliteit blijft chirurgisch overleg een <em>klinische afweging.</em> <strong>Compressie</strong> en de voorkeur voor een semi-rigide brace boven bandage (Vuurberg et al., BJSM 2018 — richtlijn): <em>richtlijnaanbeveling, in dit dossier niet nagekeken.</em> <strong>Gewichtdragen</strong> zo snel mogelijk op geleide van pijn is <em>klinische richtlijn.</em>',
       ...
       exercises:[
         ...
         {name:'Semi-rigide brace / Aircast',params:[['Graad','I: tapelast · II: semi-rigide · III: Aircast 4–6 wkn'],['Doel','mechanische stabiliteit + proprioceptie']],note:'Semi-rigide brace wordt boven elastisch verband aanbevolen (Vuurberg 2018 — richtlijn, in dit dossier niet opgehaald). Graad III: Aircast of gelijkwaardig 4–6 weken. Brace beschermt mechanisch EN stimuleert proprioceptie via cutane afferenten.',cat:'manueel'}],
      ...
      {label:'Fase 2',title:'Subacuut — LOVE + Neuromusculaire Activatie',weeks:'Dag 5–21 (G-I: 5–14d · G-II: 7–21d · G-III: 14–28d)',
       evidence:'<strong>LOVE-principes</strong> (Load, Optimism, Vascularization, Exercise) sturen de subacute fase (Dubois &amp; Esculier, 2019) — <em>een editoriaal, geen trial.</em> <strong>Peroneale activatie:</strong> <em>dat zwakte bij meer dan 90% van de patiënten met chronische instabiliteit voorkomt, staat NIET in Doherty et al. (2014); dat is een epidemiologische incidentiestudie. Het cijfer is geschrapt.</em> <strong>Proprioceptietraining — let op de populatie.</strong> In de trial bij 522 sporters daalde het recidief van 33% naar 22%, een reductie van <strong>35%</strong> (relatief risico 0,63; 95% BI 0,45–0,88; number needed to treat 9) — <em>niet 47%.</em> <strong>Belangrijke beperking:</strong> bij sporters die voor hun oorspronkelijke distorsie <strong>wél medisch behandeld</strong> waren, was er géén significant verschil; het effect kwam volledig van de niet-medisch behandelde groep (Hupperets et al., 2009 — BMJ). <em>In een kinesitherapeutisch protocol is dat net de omgekeerde populatie.</em> <strong>Manuele therapie</strong> (Green et al., 2001) en de <strong>SEBT-drempel van 89%</strong> (Hertel &amp; Corbett, 2019): <em>in dit dossier niet opgehaald.</em> <strong>Chronische instabiliteit:</strong> de consensusverklaring stelt dat een <strong>groot percentage</strong> van de patiënten CAI ontwikkelt, met lagere activiteitsniveaus, lagere levenskwaliteit en meer posttraumatische artrose — <em>maar geeft geen cijfer van 25–40%</em> (Gribble et al., 2016 — BJSM).',
       ...
       exercises:[
         ...
         {name:'Weerstandsband eversie (peroneale activatie)',params:[['Reps','15'],['Sets','3'],['Band','licht → matig'],['Progressie','zittend → staand']],note:'Band om voorvoet, eversie (voet naar buiten) tegen weerstand. Traagste herstelbeweging: concentreerje op de controlefase. Peroneale reactietijd is vermoedelijk vertraagd na een distorsie — actief trainen; <em>het eerder vermelde cijfer van 90% staat niet in Doherty et al. (2014), een zuiver epidemiologische studie, en is geschrapt</em> is essentieel.',cat:'kracht'},
         ...
         {name:'Enkel-been balans op schuimmat / BOSU',params:[['Duur','30–45 sec'],['Sets','3']],note:'Instabiel vlak verhoogt proprioceptieve input aanzienlijk. Schuimmat → BOSU plat → BOSU bol. Progressie elke 3–4 sessies bij pijnvrije uitvoering. Hupperets RCT 2009: 35% recidiefreductie (relatief risico 0,63; niet 47%).',cat:'stabiliteit'},
         {name:'SEBT (Star Excursion Balance Test)',params:[['Richtingen','anterieur, posteromediaal, posterolateraal'],['Meting','cm + LSI t.o.v. gezonde zijde']],note:'Meet functionele enkestabiliteit en proprioceptie. Anteromediaal bereik < 89% LSI wordt als praktijkdrempel gebruikt (Hertel &amp; Corbett 2019 — in dit dossier niet opgehaald). Gebruik als progressiecriteria. Meet elke 1–2 weken.',cat:'test'},
      ...
      {label:'Fase 3',title:'Functionele Kracht & Loophervatting',weeks:'Week 2–5 (G-I: 1–3wkn · G-II: 2–4wkn · G-III: 3–6wkn)',
       evidence:'<strong>Return to running-criteria</strong> (pijnvrij wandelen, heel rise LSI ≥ 80%, SEBT &gt; 80%) en de <strong>norm van 25 herhalingen heel raise</strong>: <em>praktijkafspraken; Flore et al. (2024) en de APTA-richtlijn zijn in dit dossier niet opgehaald.</em> <strong>Sportbrace:</strong> bij reeds eerder geblesseerde sporters verminderde een brace de distorsies met <strong>69%</strong> (odds ratio 0,31; 95% BI 0,18–0,51) en tape met <strong>71%</strong> (0,29; 0,14–0,57); geen enkel type steun was superieur (Dizon &amp; Reyes, 2010 — J Sci Med Sport). <em>Het eerder driemaal vermelde cijfer van 53% staat er niet in — het werkelijke effect is groter — en de review onderzoekt prestatie niet.</em> <strong>Peroneale reactietijd:</strong> <em>dat die pas na 4 tot 6 weken versnelt, staat niet in Doherty et al. (2014) en is geschrapt; de opbouw zelf blijft klinische richtlijn.</em> <strong>Loopbiomechanica</strong> met verhoogde inversie bij contact: <em>klinische redenering.</em>',
      ...
      {label:'Fase 4',title:'Sportspecifieke Training & Return to Sport',weeks:'Week 3–8 (G-I: 2–3wkn · G-II: 3–6wkn · G-III: 6–12wkn)',
       evidence:'<strong>Criteriumgestuurde terugkeer</strong> in plaats van tijdgestuurd (APTA CPG 2021) en de <strong>hoptestbatterij</strong> met LSI ≥ 90% (Tassignon et al., 2019) en de <strong>side hop test</strong> (Flore et al., 2024): <em>alle drie in dit dossier niet opgehaald; de drempels zijn praktijkafspraken.</em> <strong>Sportbrace:</strong> zie fase 4 — bij eerder geblesseerde sporters 69% minder distorsies met brace en 71% met tape (Dizon &amp; Reyes, 2010); <em>de eerder vermelde 53% en de toevoeging &quot;zonder prestatieverlies&quot; zijn geschrapt.</em> <strong>Peroneale reactietijd boven 70 ms</strong> als risicodrempel: <em>geen bron, in dit dossier niet nagekeken.</em> <strong>Chronische instabiliteit</strong> is de voornaamste vermijdbare complicatie, <em>maar het percentage van 25–40% staat niet in Gribble et al. (2016).</em>',
       ...
       exercises:[
         ...
         {name:'Side hop test (SHT)',params:[['Protocol','30 cm zijwaarts, 30 sec maximale hops'],['Drempel','≥ 100 hops/30 sec']],note:'Meet neuromusculaire uithouding voor multidirectionele sport. De drempel van 100 hops is een praktijkafspraak; Flore et al. (2024) is in dit dossier niet opgehaald, dus of de test gevalideerd is, kon hier niet worden nagekeken.',cat:'test'},
         {name:'Hop test batterij (4 testen)',params:[['Testen','single, triple, crossover, 6m timed hop'],['LSI drempel','≥ 90% voor RTS']],note:'Volledige hop-testbatterij vóór RTS contactsport. Meten beide benen, LSI berekenen. Dat de combinatie van vier tests de sterkste voorspeller is (Tassignon 2019), is in dit dossier niet opgehaald.',cat:'test'},
         ...
         {name:'Preventief oefenprogramma (ANKLE protocol)',params:[['Vb','ANKLE of FIFA 11+ enkel-module'],['Freq','2×/week seizoensbegin + 1×/week in-season']],note:'Evidence-based neuromusculair preventieprogramma. Reduceert recidief met 35% bij consequente toepassing (Schiftan et al., 2015 — proprioceptieve training; de bovengrens van 50% staat er niet in en de auteurs achten het bewijs voor PRIMAIRE preventie onduidelijk). Warm-up integratie. Levenslang bij recidief-risico.',cat:'stabiliteit'}],
      ...
      {label:'Fase 5',title:'Preventie & Chronische Instabiliteit',weeks:'Mnd 3+ / langetermijn',
       evidence:'<strong>Chronische enkelinstabiliteit.</strong> De consensusverklaring stelt dat de hervalcijfers hoog zijn en dat daardoor een <strong>groot percentage</strong> van de patiënten CAI ontwikkelt, met lagere activiteitsniveaus, lagere levenskwaliteit en toenemende posttraumatische enkelartrose (Gribble et al., 2016 — BJSM). <em>De cijfers 25–40% en 50–60% en de definitie &quot;≥ 12 maanden instabiliteitsgevoel plus recidief&quot; staan niet in dat abstract en zijn geschrapt.</em> <strong>Preventie — let op wat wél is aangetoond.</strong> Proprioceptieve training verlaagde in zeven RCT&#39;s met 3726 deelnemers het risico met <strong>35%</strong> (relatief risico 0,65; 95% BI 0,55–0,77), en bij deelnemers <strong>mét</strong> een voorgeschiedenis met 36% (0,64; 0,51–0,81). <em>Voor PRIMAIRE preventie bij mensen zonder voorgeschiedenis besluiten de auteurs uitdrukkelijk dat het bewijs ONDUIDELIJK blijft: het gepoolde risico van 0,57 kwam uit twee op zichzelf niet-significante trials</em> (Schiftan et al., 2015 — J Sci Med Sport). <em>Het eerder vermelde bereik van 35–50% en de omschrijving als &quot;neuromusculair opwarmprogramma&quot; klopten niet.</em> <strong>Brace:</strong> 69% minder distorsies bij eerder geblesseerde sporters (Dizon &amp; Reyes, 2010). <strong>Chirurgie</strong> na 6 maanden falend conservatief beleid en het resultaat van 85–90%: <em>de richtlijn van Vuurberg et al. (2018) is in dit dossier niet opgehaald.</em>',
       ...
       exercises:[
         {name:'Preventief neuromusculair programma (2–3×/week)',params:[['Vb','enkel-been balans, BOSU, lateral hops, band eversie'],['Duur','10–15 min warm-up'],['Freq','elk trainingsmoment']],note:'Minimum effectieve dosis voor preventie. Integreer als warm-up vóór sport. Bij stoppen = snel terugval in proprioceptiedeficit. Hupperets 2009 RCT (n=522): 35% recidiefreductie (relatief risico 0,63; niet 47%).',cat:'stabiliteit'},
         {name:'SEBT pre-season screening (jaarlijks)',params:[['Timing','begin seizoen'],['Alarm','anteromediaal LSI < 89%']],note:'Bij LSI < 89% anteromediaal: gerichte proprioceptieperiode van 4 weken voor seizoensopstart. De predictieve validiteit van dit instrument (Hertel &amp; Corbett 2019) is in dit dossier niet nagekeken.',cat:'test'},
  ...
  over:{id:'over',title:'Overpronatie Syndroom',subtitle:'Flexibele platvoet en overpronatie — intrinsieke training, tibialis posterior, gaitretraining en orthesen',color:'#10b981',
    phases:[
      {label:'Fase 0',title:'Diagnostiek & Subclassificatie',weeks:'Eerste contact',
       evidence:'<strong>Overpronatie</strong> is geen diagnose op zich maar een biomechanisch fenomeen met een spectrum van presentaties. Onderscheid blijft essentieel: <strong>flexibele platvoet</strong> (mediale boog herstelt bij teenstand) tegenover <strong>rigide platvoet</strong> (boog herstelt niet → beeldvorming en verwijzing). <em>De FPI-6-afkapwaarden (≥ +6 en ≥ +10), de drempel van 10 mm voor de navicular drop (Brody 1982) en de lijst gerelateerde klachten zijn in dit dossier niet nagekeken.</em> <strong>Posterieure tibialis-insufficiëntie</strong> als aparte entiteit blijft <em>klinische richtlijn.</em> <em>De claims dat gait retraining superieur is aan orthesen alleen (Mousavi et al., 2024) en dat een bepaalde oefencombinatie &quot;de meest effectieve interventie&quot; is (netwerk-meta-analyse 2024) zijn in dit dossier niet opgehaald; die laatste referentie staat in het bronnenbestand zonder auteurs, wat ze onnaspeurbaar maakt.</em>',
       ...
       exercises:[
         {name:'Foot Posture Index-6 (FPI-6)',params:[['Score','-12 tot +12'],['Normaal','0 tot +5'],['Geproneerd','≥ +6 (afkapwaarde niet nagekeken)'],['Hyperpronatie','≥ +10 (afkapwaarde niet nagekeken)']],note:'6 items: talauskop palpatie, supra/infra-malleolaire curvatuur, calcaneus frontaal vlak, talo-naviculaire prominentie, mediale longitudinale boog congruentie, voor/achtervoet abductie. Interrater betrouwbaar (ICC 0.70–0.89).',cat:'test'},
         {name:'Navicular Drop Test (NDT)',params:[['Meting','naviculaire hoogte zittend vs staand'],['Significant','≥ 10 mm zakking (drempel niet nagekeken)'],['Norm','4–9 mm (niet nagekeken)']],note:'Zittend (non-weightbearing): markeer tuberositas naviculare, meet hoogte t.o.v. grond. Herhaal staand (full weightbearing). Verschil = navicular drop. > 10mm = overpronatie. Reproduceerbaar (ICC 0.79).',cat:'test'},
         {name:'Single Heel Raise Test (SHRT)',params:[['Flexibel','boog herstelt bij op de teen gaan'],['Rigide','boog herstelt NIET'],['Grens','< 20 reps (praktijkafspraak, niet onderbouwd)']],note:'Patiënt gaat op één voet op de teen staan. Flexibele platvoet: mediale boog verschijnt bij teen-stand. Rigide platvoet: geen boogvorming → beeldvorming overwegen. Tel maximale reps: norm > 25.',cat:'test'},
         {name:'Rearfoot eversie observatie (lopen)',params:[['Tool','observatie of videogait'],['Normaal','< 5° eversie bij initieel contact (niet onderbouwd)']],note:'Observeer van achter. Excessieve rearfoot eversie bij initieel contact = overpronatie. Koppel aan knievalgusneiging (dynamic knee valgus) — mediale kniepijn predictor. Eventueel met smartphone slowmotion.',cat:'test'}],
      ...
      {label:'Fase 1',title:'Intrinsieke Voetspieractivatie',weeks:'Week 1–4',
       evidence:'<strong>Short Foot Exercise (SFE).</strong> Een systematische review van negen gerandomiseerde studies vond dat vier van de zes studies over de mediale lengteboog verbetering rapporteerden, en dat verbetering optrad bij interventies van <strong>vijf weken of langer</strong>. De auteurs benadrukken dat er <strong>géén consensus</strong> bestaat over aantal en frequentie van de oefeningen en dat het <strong>mechanisme onduidelijk</strong> is (Hara et al., 2023 — J Back Musculoskelet Rehabil). <em>De meta-analyse van Huang et al. (2022) met haar cijfers voor navicular drop en FPI-6 is in dit dossier niet opgehaald.</em> <strong>Abductor hallucis</strong> als primaire dynamische boogstabilisator en de hypertrofie na vier weken: <em>klinische redenering, niet nagekeken.</em> <em>De progressie van intrinsiek naar extrinsiek steunt op een referentie die in het bronnenbestand als &quot;Wetenschappers Sci Reports, 2024&quot; staat — dat is geen bruikbare bronvermelding en is als zodanig gemarkeerd.</em> <strong>Vier progressiestadia</strong> (Kim et al., 2019): <em>niet opgehaald.</em>',
      ...
      {label:'Fase 2',title:'Extrinsieke Krachtopbouw — Tibialis Posterior & Heup',weeks:'Week 3–10',
       evidence:'<strong>Tibialis posterior — wat de bron werkelijk zegt.</strong> De aangehaalde MRI-studie vergeleek bij <strong>vijf gezonde volwassenen</strong> drie oefeningen op selectieve activatie. <strong>Gesloten-keten voetadductie tegen weerstand</strong> gaf veruit de sterkste activatie van de tibialis posterior (+50%, tegenover minder dan 5% in de andere spieren), terwijl bij de <strong>hielheffing</strong> de mediale gastrocnemius (+99%), peroneus longus (+57%) en soleus (+39%) de tibialis posterior (+27%) overvleugelden (Kulig et al., 2004 — MSSE). <em>Er staat géén excentrisch protocol en géén vergelijking excentrisch tegenover concentrisch bij PTTD in; die claim is geschrapt.</em></em> <strong>Praktische consequentie:</strong> wie de tibialis posterior gericht wil trainen, kiest voetadductie en niet de hielheffing. <em>De netwerk-meta-analyse met MD 3,32 (95% BI 1,78–4,89), de heupclaims (Sánchez-Rodríguez et al., 2020) en het iliopsoas-mechanisme zijn in dit dossier niet opgehaald.</em>',
       ...
       exercises:[
         ...
         {name:'Gastrocnemius + soleus stretch',params:[['Hold','45 sec'],['Sets','3×/zijde'],['Freq','2–3×/dag']],note:'Beperkte dorsaalflexie wordt klinisch als bijdragende factor voor compensatoire overpronatie beschouwd; dat verband is in dit dossier niet nagekeken. Stretch gastrocnemius (knie gestrekt) + soleus (knie gebogen) op een traptrede. Het zogenaamde Gombault-criterium is in dit dossier niet opgehaald: < 10° dorsaalflexie = compensatiemechanisme actief.',cat:'mobiliteit'},
         {name:'Heupabductie en externe rotatie (weerstandsband)',params:[['Reps','15'],['Sets','3'],['Band','licht → matig']],note:'Zijlig: abductie heup met band boven knieën. Dan: staand, knie 90° gebogen, externe rotatie tegen band. Een verband tussen gluteuszwakte en verhoogde eversie is in dit dossier niet nagekeken (verhoogde knievalgusneiging EN verhoogde rearfoot eversie. Essentieel bij PFPS-gerelateerde pronatie.',cat:'kracht'},
      ...
      {label:'Fase 3',title:'Functionele Stabilisatie & Proprioceptie',weeks:'Week 6–14',
       evidence:'<strong>Gecombineerde SFE met heupabductie</strong> (RCT 2024, BMC Sports) en <strong>gait retraining</strong> met rearfoot eversie, stapbreedte en voetprogressiehoek (Mousavi et al., 2024): <em>beide in dit dossier niet opgehaald; de cues blijven klinische richtlijn.</em> <em>De claim dat proprioceptietraining op instabiel vlak de rearfoot eversie tijdens het gaan verlaagt, werd toegeschreven aan Hara et al. (2023) — die systematische review gaat echter over short foot exercises en bevat geen proprioceptie-interventie en geen eversiemeting. De claim is losgekoppeld van die bron en blijft klinische redenering.</em>',
       ...
       exercises:[
         ...
         {name:'SFE + isometrische heupabductie (gecombineerd)',params:[['Reps','10'],['Hold','5 sec'],['Sets','3']],note:'Staand, band boven knieën. Voer SFE uit TERWIJL je de knieën actief tegen de band drukt (isometrische heupabductie). De claim over verhoogde abductor hallucis-activatie steunt op een RCT uit 2024 die in dit dossier niet is opgehaald (RCT 2024). Synergie distaal-proximale ketting.',cat:'stabiliteit'},
         {name:'Gait retraining — parallelle voetstand',params:[['Cue','"Zet je voeten meer parallel"'],['Methode','spiegel of videofeedback'],['Sessies','6–8 sessies à 20 min']],note:'Toe-out looppatroon vergroot pronatie. Reductie van de toe-out hoek met 5–10° wordt klinisch toegepast; Mousavi et al. (2024) is in dit dossier niet opgehaald (Mousavi 2024). Gebruik vloermarkeringen of visuele feedback. Automatisering: 4–6 weken constante cueing.',cat:'neuro'},
      ...
      {label:'Fase 4',title:'Sportspecifieke Training & Preventie',weeks:'Week 10–18+',
       evidence:'<strong>Orthesen als aanvulling.</strong> In de aangehaalde studie kregen 26 mensen met patellofemoraal pijnsyndroom prefab-inlegzolen; 25 voltooiden de studie en na twaalf weken meldden daarvan <strong>slechts zeven (28%)</strong> duidelijke verbetering. Een grotere piek-rearfoot-eversie was daarbij de enige significante onafhankelijke voorspeller, en de auteurs noemen dit zelf <strong>voorlopig bewijs</strong> (Barton et al., 2011 — BJSM). <em>Er staat géén drempel van 3° in; die is geschrapt. Het percentage van 28% ontbrak en is net wat de patiënt moet weten voor hij inlegzolen aanschaft.</em> <em>Dat orthesen afhankelijkheid creëren, dat minimalistisch schoeisel de intrinsieke spieren stimuleert en dat een abrupte overgang tot stressfracturen leidt, zijn klinische redeneringen zonder bron in dit dossier.</em> <strong>Jaarlijkse screening</strong> met FPI-6 en navicular drop blijft een <em>praktijkafspraak.</em>',
       ...
       criteria_stop:['Persisterende hyperpronatie na optimale therapie → maatorthesen + podoloog (de drempel FPI > +9 heeft geen bron en strookt niet met de hyperpronatiegrens ≥ +10 in fase 0)'],
    ...
    refs:'Kulig K et al. (2004) — <strong>Selective activation of tibialis posterior: evaluation by MRI</strong>. Med Sci Sports Exerc 36(5):862-7; vijf gezonde proefpersonen, voetadductie activeert de TP het sterkst; GEEN excentrisch protocol en geen PTTD-patienten. | Hara S et al. (2023) — The effects of short foot exercises to treat flat foot deformity: systematic review. J Back Musculoskelet Rehabil 36(1):21-33; negen studies, geen consensus over dosering, mechanisme onduidelijk. | Barton CJ et al. (2011) — Greater peak rearfoot eversion predicts foot orthoses efficacy in PFPS. Br J Sports Med 45(9):697-701; slechts 28% duidelijke verbetering, door de auteurs zelf voorlopig bewijs genoemd, geen drempel van 3 graden. | Mousavi SH et al. (2024), Huang C et al. (2022), Sanchez-Rodriguez R et al. (2020), Alam F et al. (2018), Kim et al. (2019) en Brody (1982) — in dit dossier niet opgehaald. | De referentie die in de app als &quot;netwerk-meta-analyse (2024), Sci Reports&quot; en als &quot;Wetenschappers Sci Reports, 2024&quot; stond, heeft geen auteurs en is daardoor niet naspeurbaar.'},
  ...
  si:{id:'si',title:'Schouderinstabiliteit',subtitle:'Anterieure instabiliteit (TUBS / Bankart) en multidirectionele instabiliteit (AMBRI) — conservatief & post-chirurgisch',color:'#f472b6',
    phases:[
      {label:'Fase 1',title:'Immobilisatie & Bescherming',weeks:'Week 0–3',
       evidence:'<strong>Immobilisatiestand — de twee trials werden verwisseld.</strong> De trial van Itoi et al. (2007, n = 198) was niet klein: immobilisatie in externe rotatie gaf daar 26% recidief tegenover 42% in interne rotatie (p = 0,033), een relatieve risicoreductie van 38,2% en 46,1% bij dertigjarigen en jonger. <em>De eerder vermelde cijfers 0% tegenover 30% staan er niet in.</em> De trial van Liavaag et al. (2011) telde 188 deelnemers, niet 198, en vond géén verschil: 24,7% na interne tegenover 30,8% na externe rotatie (p = 0,36). <strong>De twee grote RCT&#39;s spreken elkaar dus tegen</strong>; een neutrale draagdoek van 3 tot 4 weken is een praktijkafspraak die geen van beide trials onderzocht. Bij AMBRI direct starten met rust en periscapulaire activatie, en de beschadiging van de n. axillaris bij 5 tot 14% van de anterieure luxaties, zijn <em>klinische richtlijn; in dit dossier niet tegen een bron gelegd.</em>',
       ...
       redflags:['N. axillaris letsel: deltoidverlamming of gevoelsverlies laterale bovenarm → onmiddellijk chirurgconsult (5–14% incidentie na anterieure luxatie — cijfer in dit dossier niet onderbouwd; de rode vlag zelf blijft onverkort gelden)','Wondinfectie: roodheid, warmte, pusvorming → spoedconsult','CRPS-tekenen: brandende pijn, huidveranderingen, oedeemfixatie → revalidatiearts']},
      {label:'Fase 2',title:'Vroege ROM & Scapulaire Basis',weeks:'Week 3–8',
       evidence:'<strong>Scapulaire dyskinese:</strong> het consensusdocument stelt dat dyskinese bij een hoog percentage van de schouderletsels voorkomt, maar geeft géén cijfer van 67% en benadrukt dat haar rol bij het ontstaan van schouderdisfunctie <strong>niet duidelijk omschreven</strong> is (Kibler et al., 2013 — BJSM, bewijsniveau 5). <em>Het percentage is geschrapt.</em> Dat de serratus anterior de primaire stabilisator is voor upward rotation, de beperking van passieve ER tot 30° tot week 6 na Bankart, en GIRD boven 20° als onafhankelijke risicofactor zijn <em>klinische richtlijn; in dit dossier niet onderbouwd.</em>',
       ...
       criteria_go:['Passieve elevatie ≥ 90°','Actieve elevatie ≥ 60° pijnvrij','IR ≥ 60°','Post-Bankart passieve ER ≤ 30° of conservatief full ER (praktijkafspraak; geen brondrempel)','Scapulaire winging verdwenen bij wall slides','Pijn ≤ 3/10'],
      ...
      {label:'Fase 3',title:'Krachtherstel & Neuromusculaire Controle',weeks:'Week 8–16',
       evidence:'<strong>ER/IR-verhouding:</strong> de aangehaalde studie is een <strong>beschrijvende normatieve meting bij 125 gezonde professionele honkbalwerpers</strong> — geen patiënt met instabiliteit, geen preventieve uitkomst en geen afkapwaarde van 0,66 (Ellenbecker &amp; Mattalino, 1997 — JOSPT). <em>De preventieclaim kan daar niet uit komen en is geschrapt; de verhouding blijft bruikbaar als praktijkafspraak.</em> Wat er wél in staat: aan de werparm is de intrarotatiekracht significant groter (p &lt; 0,001), terwijl er voor exorotatie géén significant verschil tussen beide zijden werd gevonden. <strong>Proprioceptie:</strong> bij instabiele schouders zijn kinesthesie en gewrichtspositiezin significant slechter dan aan de gezonde zijde, maar na reconstructie is dat verschil verdwenen — de auteurs besluiten dat chirurgie een deel van de proprioceptie <strong>herstelt</strong> (Lephart et al., 1994). <em>Er is geen opvolging in de tijd, dus de bewering dat deficieten tot 6 maanden persisteren staat er niet in.</em> De claim over PNF D2-diagonalen is <em>klinische redenering.</em>',
       goals:['Volledige actieve ROM (elevatie ≥ 170°, ER ≥ 60°, IR ≥ 70°)','ER/IR krachtverhouding ≥ 0.66 (praktijkafspraak — Ellenbecker 1997 geeft geen afkapwaarde)','ER-krachtsasymmetrie ≤ 20%','Scapulaire upward rotation normaal bij elevatie','JPS (joint position sense) fout < 5° bij 45° abductie (praktijkafspraak, niet onderbouwd in dit dossier)','Overhead bewegen zonder compensatiepatroon'],
       exercises:[
       ...
       criteria_go:['Actieve elevatie ≥ 170°, ER ≥ 60°, IR ≥ 70°','ER/IR ratio ≥ 0.66 (praktijkafspraak)','ER-asymmetrie ≤ 20% (praktijkafspraak)','JPS fout < 5° (praktijkafspraak, niet onderbouwd)','Pijn ≤ 2/10 bij alle oefeningen','Geen instabiliteitsgevoel bij dagdagelijkse activiteiten'],
       criteria_stop:['ER/IR ratio < 0.60 na 14 weken (praktijkdrempel, niet onderbouwd) → intensiveer ER-specifiek + eventueel isokinetisch testen'],
       redflags:[]},
      {label:'Fase 4',title:'Dynamische Stabilisatie & Functioneel',weeks:'Week 16–24',
       evidence:'<strong>Gesloten keten:</strong> de aangehaalde EMG-studie bij 18 <strong>gezonde</strong> studenten mat zeven statische gewichtdragende posities. Er is <strong>geen vergelijking met open keten</strong>, geen bovenhandse oefening en geen revalidatie-uitkomst; wat er wel in staat is een sterke correlatie tussen gewichtdragende houding en spieractiviteit (r = 0,97; p &lt; 0,01), een lage belasting in bidhouding en vierpuntsstand (2–10% MVIC) en de infraspinatus als actiefste spier in de meeste van de geteste posities (Uhl et al., 2003 — JOSPT). <em>De superioriteit boven open keten is dus klinische redenering, geen bevinding.</em> Terugkeer naar werpen na minimaal 6 maanden en rhythmic stabilization in 90/90° als verplichte stap zijn <em>praktijkafspraken; de citatie Wilk (2013) staat in het refs-veld als 2009 en is in dit dossier niet opgehaald.</em>',
       goals:['Push-up 3×10 volledig pijnvrij','Overhead press ≥ 8 kg pijnvrij','Dynamische stabilisatie in 90/90° positie stabiel (45 sec)','Sport-specifieke bewegingen geïntroduceerd','WOSI ≤ 630 (70% van normaal — praktijkdrempel, in dit dossier niet onderbouwd)'],
       exercises:[
         ...
         {name:'Interval Throwing Program stap 1–3 (werpatleten)',params:[['Afstand','45 voet → 60 voet → 90 voet']],note:'Enkel bij werpatleten + chirurggoedkeuring. Na minimum 6 maanden post-Bankart (praktijkafspraak). Het protocol van Wilk staat in het refs-veld als 2009 en in de tekst als 2013; het is in dit dossier niet opgehaald.',cat:'neuro'}],
      ...
      {label:'Fase 5',title:'Return to Sport',weeks:'Mnd 6–9',
       evidence:'<strong>Recidief na artroscopische Bankart:</strong> in de systematische review bedroeg het herval 6,4% artroscopisch en 8,2% open — vergelijkbaar. <em>Het cijfer van 15 tot 20% voor contactsporters staat er niet in.</em> Klinisch beslissend en eerder weggelaten: na een <strong>eerste</strong> traumatische luxatie bij jonge patiënten gaf chirurgie 7% herval tegenover 46% conservatief na twee jaar, en 10% tegenover 58% op langere termijn (Brophy &amp; Marx, 2009 — Arthroscopy). <strong>ISIS boven 6 punten</strong> ging in een reeks van 131 patiënten gepaard met een recidiefrisico van <strong>70%</strong> (p &lt; 0,001); de auteurs beschouwen een artroscopische Bankart dan als gecontra-indiceerd en stellen een Bristow-Latarjet voor (Balg &amp; Boileau, 2007). <strong>Conservatief bij AMBRI — let op het contrast:</strong> hetzelfde oefenprogramma gaf een goed of uitstekend resultaat bij <strong>80%</strong> van de ATRAUMATISCHE subluxaties (53/66) maar bij slechts <strong>16%</strong> van de traumatische (12/74) (Burkhead &amp; Rockwood, 1992). <em>De eerder vermelde bovengrens van 90% staat er niet in, en juist dat contrast is de reden om AMBRI anders te behandelen dan TUBS.</em> Dat een preventief onderhoudsprogramma het recidief verlaagt, is <em>klinische redenering.</em>',
       goals:['Krachtsasymmetrie ≤ 10% (ER, abductie)','ER/IR ratio ≥ 0.66 gehandhaafd','WOSI ≤ 420 (≥ 80% normaal — praktijkdrempel, in dit dossier niet onderbouwd)','Interval Sport Program voltooid','Sport-specifieke bewegingen pijnvrij en stabiel','Chirurgische goedkeuring (post-Bankart)'],
       exercises:[
         {name:'Interval Throwing Program compleet (werpatleten)',params:[['Fase','4–6: 120 voet → max. afstand → bullpen']],note:'Minimum 6 weken voor fase 4–6, geen pijn of vermoeidheid van de schouder als criterium — praktijkafspraak; het protocol van Wilk is in dit dossier niet opgehaald.',cat:'neuro'},
    ...
    refs:'Itoi E et al. (2007) — Immobilisatie in externe rotatie na eerste luxatie: RCT, n = 198, recidief 26% tegenover 42% (p = 0,033). J Bone Joint Surg Am 89(10):2124-31. | Liavaag S et al. (2011) — Zelfde vraag, RCT, n = 188: GEEN verschil (24,7% tegenover 30,8%; p = 0,36). J Bone Joint Surg Am 93(10):897-904. | Kibler WB et al. (2013) — Consensusverklaring scapulaire dyskinese, bewijsniveau 5; geen percentage. Br J Sports Med. | Lephart SM et al. (1994) — Proprioceptie bij gezonde, instabiele en geopereerde schouders; dwarsdoorsnede, geen opvolging in de tijd. J Shoulder Elbow Surg 3(6):371-80. | Ellenbecker TS &amp; Mattalino AJ (1997) — Isokinetische NORMWAARDEN bij 125 gezonde honkbalwerpers; geen instabiliteitspopulatie. J Orthop Sports Phys Ther 25(5):323-8. | Uhl TL et al. (2003) — EMG bij 18 gezonde studenten tijdens gewichtdragende posities; geen vergelijking met open keten. J Orthop Sports Phys Ther 33(3):109-17. | Balg F &amp; Boileau P (2007) — Instability severity index score; boven 6 punten 70% recidief. J Bone Joint Surg Br 89(11):1470-7. | Brophy RH &amp; Marx RG (2009) — Chirurgie 7% tegenover conservatief 46% herval na twee jaar; artroscopisch 6,4% en open 8,2%. Arthroscopy 25(3):298-304. | Burkhead WZ &amp; Rockwood CA (1992) — Oefenprogramma: 80% goed bij ATRAUMATISCHE, 16% bij traumatische subluxatie. J Bone Joint Surg Am 74(6):890-6. | Wilk KE et al. — interval throwing program; in dit dossier niet opgehaald (jaartal in de tekst 2013, in de oorspronkelijke refs 2009).'},
  ...
  orif:{id:'orif',title:'ORIF Distale Radius',subtitle:'Open repositie & interne fixatie van distale radiusfractuur (AO type A2–C3) — postoperatief revalidatieprotocol pols & hand',color:'#38bdf8',
    phases:[
      {label:'Fase 1',title:'Bescherming & Oedeemcontrole',weeks:'Week 0–2',
       evidence:'Volaire plaatfixatie laat <strong>vroege mobilisatie van aangrenzende gewrichten</strong> toe vanaf dag 1–3 postoperatief. <em>De aangehaalde publicatie van Souer et al. (2011) is in dit dossier niet opgehaald; dat vroeg mobiliseren van vingers en elleboog stijfheid en oedeem significant vermindert, is dus niet nagekeken.</em> <strong>Elevatie boven hartniveau</strong> als meest effectieve oedeemreductie: <em>klinische richtlijn zonder bron.</em> De pols blijft in spalk of brace tot radiologische controle — <em>praktijkafspraak.</em>',
      ...
      {label:'Fase 2',title:'Vroege ROM Pols & Littekenzorg',weeks:'Week 2–6',
       evidence:'<strong>Start van actieve polsmobilisatie — hier spreken twee trials elkaar tegen, en dat hoort de patiënt te weten.</strong> Een pilotstudie bij <strong>30 patiënten</strong> vond dat onmiddellijke mobilisatie beter was dan vijf weken immobilisatie: betere bewegingsuitslag, betere grijpkracht tot zes maanden en betere DASH- en PRWE-scores tot zes weken (Quadlbauer et al., 2017 — J Wrist Surg). <strong>Maar</strong> een grotere gerandomiseerde trial bij <strong>60 patiënten</strong> vond <strong>géén verschil</strong> tussen starten binnen twee weken en pas starten na zes weken — niet in flexie-extensieboog na drie maanden (104 tegenover 107°; p = 0,61) of zes maanden (124 tegenover 126°; p = 0,65), en evenmin in grijpkracht, DASH of pijn (Lozano-Calderón et al., 2008 — JBJS Am). <em>Vroeg starten is dus verdedigbaar en veilig, maar de winst ervan is niet vastgesteld. Het verschil zit vermoedelijk in de vergelijking: vijf weken immobilisatie is iets anders dan starten na zes weken.</em> <strong>Pronosupinatie</strong> herstelt trager dan flexie-extensie en <strong>littekenmassage</strong> vanaf dag 14: <em>klinische richtlijn; het woord &quot;significant&quot; bij de littekenmassage is geschrapt omdat er geen bron voor is.</em>',
       ...
       exercises:[
         ...
         {name:'Grijpkracht — zachte putty',params:[['Reps','15–20'],['Sets','3'],['Weerstand','zacht (geel/rood)']],note:'Volledig knijpen in putty. Progressie naar harder materiaal. Dat het herstel van de grijpkracht bepalend is voor de functionele uitkomst, is in dit dossier niet nagekeken.',cat:'kracht'},
         ...
         {name:'Littekenmassage',params:[['Duur','3–5 min'],['Freq','2×/dag'],['Start','dag 14 postoperatief']],note:'Cirkelvormige druk op litteken (niet erover). Cross-friction in 4 richtingen. Siliconen sheet als aanvulling 23u/dag. Dat dit de adhesievorming verlaagt, is in dit dossier niet nagekeken.',cat:'manueel'},
      ...
      {label:'Fase 3',title:'Krachtherstel & Functionele Integratie',weeks:'Week 6–12',
       evidence:'<em>De drempel van 75% grijpkracht wordt in de app aan MacDermid et al. (2004) toegeschreven, maar het refs-veld beschrijft die publicatie als een validatiestudie van de PRWE-vragenlijst — een ander onderwerp. De bron is in dit dossier niet opgehaald en de drempel is een praktijkafspraak.</em> Dat de pronosupinatiekracht het traagst herstelt, is <em>klinische ervaring.</em> <em>Dat zwaar-langzame weerstand effectiever zou zijn dan lage weerstand met veel herhalingen voor botgenezing én peeskracht, en dat tweemaal per dag oefenen superieur is aan eenmaal, heeft in dit dossier geen bron; beide zijn geschrapt als effectclaim en blijven als praktijkafspraak staan.</em>',
      ...
      {label:'Fase 4',title:'Volledig Functioneel & Return to Sport',weeks:'Week 12–20',
       evidence:'<em>De hersteltermijn van 12 tot 24 maanden wordt aan Lozano-Calderón et al. (2008) toegeschreven, maar die trial gaat over het tijdstip van mobiliseren en bevat die termijn niet. Wat er wél in staat, is hierboven bij fase 2 opgenomen.</em> Dat functioneel herstel voor dagelijkse activiteiten en recreatieve sport haalbaar is binnen 3 tot 5 maanden, en de PRWE-drempel van 20, zijn <em>praktijkafspraken zonder bron in dit dossier.</em> <strong>Sportspecifieke revalidatie</strong> en <strong>work hardening</strong> voor manuele beroepen zijn <em>klinische richtlijn.</em>',
    ...
    refs:'Lozano-Calderón SA et al. (2008) — <strong>Wrist mobilization following volar plate fixation of fractures of the distal part of the radius</strong>. J Bone Joint Surg Am 90(6):1297-304; RCT bij 60 patienten, GEEN verschil tussen mobiliseren binnen twee weken en na zes weken. | Quadlbauer S et al. (2017) — Early rehabilitation of distal radius fractures stabilized by volar locking plate: prospective randomized PILOT study. J Wrist Surg 6(2):102-112; slechts 30 patienten, vroege mobilisatie beter dan vijf weken immobilisatie. | Souer JS et al. (2011), MacDermid JC et al. (2004), Arora R et al. (2011), Valdes K &amp; Naughton N (2014) en Ruch DS &amp; Papadonikolakis A (2006) — in dit dossier niet opgehaald. | LET OP: het refs-veld beschreef Lozano-Calderón eerder als &quot;Quality and strength of evidence for etiology in orthopaedic research&quot; — dat is een andere publicatie.'},

  // ─────────────────────────────────────────────────────────────────
  // DE QUERVAIN TENOSYNOVITIS
  // Evidence: Peters-Veluthamaningal 2009 — in dit dossier niet opgehaald (Cochrane), Cavaleri 2016
  // meta-analyse, Goel &amp; Abzug 2015 — in dit dossier niet opgehaald, Chern 2014 — in dit dossier niet opgehaald (EPB-subcompartiment),
  ...
  dq:{
    ...
    phases:[
      {
        ...
        evidence:'<strong>Combinatie boven monotherapie.</strong> In de meta-analyse gaf de <strong>combinatie</strong> van orthese en corticosteroïdinjectie meer behandelsucces dan een orthese alleen (relatief risico 0,53; 95% BI 0,35–0,80) en dan een injectie alleen (0,76; 0,64–0,89). <em>Belangrijker voor de kinesitherapeut, en weggelaten: injectie en handtherapie verbeterden beide pijn en functie, maar het VERSCHIL TUSSEN BEIDE was over zes studies NIET significant. Het eerder vermelde number needed to treat van 3 staat er niet in</em> (Cavaleri et al., 2016 — J Hand Ther). <em>Peters-Veluthamaningal et al. (2009 — Cochrane) en Goel &amp; Abzug (2015) zijn in dit dossier niet opgehaald; de duim-spica spalk 23 uur per dag is een praktijkafspraak.</em>',
        goals:['Pijn reduceren tot NRS ≤ 3 in rust','APL/EPB-pees ontlasten via adequate spalking','Patiënt informeren over anatomisch variant (34% EPB eigen subcompartiment — Chern 2014 — in dit dossier niet opgehaald)','Behoud ROM vingers en pols zonder duimstress','Activiteitsmodificatie implementeren'],
        exercises:[
          {name:'Duim-spica spalk (rigid of semi-rigid)',params:[['Duur','23u/dag'],['Positie','pols 15° extensie, duim in functionele abductie'],['Afname','alleen voor hygiëne']],note:'Strikt 23u/dag de eerste 4 weken — Consequent spalkgebruik is een praktijkafspraak; Cavaleri et al. (2016) onderzocht therapietrouw of spalkduur niet. Controleer drukpunten op processus styloideus radii.',cat:'manueel'},
          ...
          {name:'Neurale mobilisatie n. radialis superficialis',params:[['Sets','2'],['Reps','8–10'],['Snelheid','traag, geen pijn']],note:'Chern 2014 — in dit dossier niet opgehaald: n. radialis superficialis kan geïrriteerd zijn door inflammatie rond eerste compartiment. Zachte neurale mobilisatie: schouder depressie + elleboogextensie + polsflexie + ulnaire deviatie + duim gebogen. Voorzichtig in acute fase.',cat:'neuro'}
        ],
        ...
        criteria_stop:['NRS toename > 2 na oefening → terug naar volledige rust','Tintelingen of gevoelloosheid dorsale duim → n. radialis superficialis neuropathie uitsluiten','Geen verbetering na 4 weken → corticosteroïdinjectie overwegen (Peters-Veluthamaningal 2009 — in dit dossier niet opgehaald)'],
      ...
      },
      {
        ...
        evidence:'<strong>Progressieve belasting</strong> volgens het tendinopathie-continuüm (Cook &amp; Purdam, 2009): <em>in dit dossier niet opgehaald; de uitspraak over collageen type-I-remodellering door excentrische belasting is niet nagekeken.</em> <em>De vergelijking &quot;progressieve krachttraining superieur aan verdere immobilisatie&quot; wordt aan Cavaleri et al. (2016) toegeschreven, maar die meta-analyse vergelijkt handtherapie en injecties, niet trainingsvormen onderling; de claim is geschrapt.</em> <strong>Afbouw van de spalk</strong> na vier weken bij goede pijncontrole (Backstrom, 2002): <em>niet opgehaald; praktijkafspraak.</em>',
        ...
        exercises:[
          ...
          {name:'Excentrische APL/EPB training (Cook & Purdam protocol)',params:[['Sets','3'],['Reps','15'],['Tempo','3 sec excentrisch / 1 sec concentrisch'],['Freq','eens daags']],note:'Excentrische fase: weerstandsband aan duim, langzame adductie terugkeer. Excentrische belasting boven passieve rust is klinische redenering; Cook &amp; Purdam (2009) is in dit dossier niet opgehaald. Verwacht initieel milde pijn (NRS ≤ 4) tijdens oefening — normaal in reactieve tendinopathie. Stop bij NRS > 5.',cat:'kracht'},
          ...
          {name:'Pincetgreep progressief (tip-to-tip & lateral)',params:[['Sets','3'],['Reps','10–15'],['Materiaal','knijpbal, Thera-Putty, wasknijpers']],note:'Pincetgreep belast APL indirect. Begin met tip-to-tip (lager krachtvereiste), dan laterale greep (hogere APL-belasting). Goel &amp; Abzug 2015 — in dit dossier niet opgehaald: pincetgreep normalisering belangrijk voor RTA bij kantoor- en zorgpersoneel.',cat:'kracht'},
          ...
          {name:'Ergonomische werkhervatting — spalkvrij beleid',params:[['Start','week 6–8'],['Protocol','geleidelijke blootstelling'],['Hulpmiddelen','ergonomische grip, polspads']],note:'Spalk volledig afbouwen naar nachtgebruik week 6, dan volledig stop week 8 indien pijnvrij. Geleidelijk afbouwen van de spalk is klinische richtlijn; Backstrom (2002) is in dit dossier niet opgehaald. Aanpassen werkplek: toetsenbordhoek, muispositie, telefoonfixatie.',cat:'neuro'}
        ],
      ...
      },
      {
        ...
        evidence:'<em>De hersteltermijn van 4 tot 6 maanden (Goel &amp; Abzug, 2015) en het recidiefpercentage van 50% bij te vroege volledige belasting (Ilyas, 2007) zijn beide in dit dossier niet opgehaald. Dat laatste cijfer is bovendien als &quot;retrospectieve data&quot; aangeduid zonder verdere onderbouwing, terwijl het de belastingsopbouw van deze fase stuurt.</em> Dat degeneratieve tendinopathie een langdurig progressief belastingsprotocol vraagt, blijft <em>klinische richtlijn.</em>',
        ...
        exercises:[
          {name:'Weerstandstraining duim — progressief (HSR-principe)',params:[['Sets','4'],['Reps','6–8RM'],['Freq','3×/week'],['Progressie','elke 2 weken indien pijnvrij']],note:'High-load slow resistance (principe uit onderzoek aan de ACHILLESpees (Beyer 2015) — niet aan de duimpezen onderzocht op pees): zware last, trage snelheid, volledig ROM. Theraband, polsgewichten, of handergometer. Stimuleert peescollageen type-I synthese. NRS ≤ 4 tijdens oefening toegestaan.',cat:'kracht'},
          {name:'Pincetgreep kracht — dynamometer progressie',params:[['Meting','elke 2 weken'],['Doel','≥ 90% contralateraal'],['Oefening','Thera-Putty, knijpballen, grip trainer']],note:'Laterale pincetgreep (sleutelgreep) sterkst gelinkt aan APL-functie. Tip-to-tip pincetgreep linkt meer aan EPB. Monitor beide. Goel &amp; Abzug 2015 — in dit dossier niet opgehaald: pincetgreep normalisering = primaire functionele maatstaf RTA.',cat:'kracht'},
          ...
          {name:'Sportspecifieke training — discipline-afhankelijk',params:[['Richtlijn','golf: week 12, tennis: week 14–16, gewichtheffen: week 14 — praktijkafspraken, niet onderbouwd'],['Belasting','progressief, pijngestuurd']],note:'Golf: driving stroke belast APL/EPB zwaar — start op chipping, dan half swing. Tennis: backhand en smash meest belastend. Geleidelijke sporthervatting is klinische richtlijn; het eerder vermelde recidiefcijfer van 50% is in dit dossier niet opgehaald. Beschermende brace aanbevolen eerste 4–6 weken sporthervatting.',cat:'cardio'},
          {name:'Preventie-educatie & zelfmanagement',params:[['Duur','20 min sessie'],['Inhoud','ergonomie, warmoefeningen, belastingsgrenzen'],['Materiaal','handout + oefenprogramma']],note:'Bespreek risicofactoren: zwangerschap/kraamperiode (hormonaal), nieuwe activiteiten (muziekinstrument, tuinieren), repetitieve radiale deviatie. Instrueer home exercise program 2×/week als onderhoud. Recidiefsymptomen: direct consulteren voor vroege injectie (Peters-Veluthamaningal 2009 — in dit dossier niet opgehaald).',cat:'neuro'}
        ],
    ...
    refs:'Cavaleri R et al. (2016) — Hand therapy versus corticosteroid injections in de Quervain&#39;s disease: systematic review and meta-analysis. J Hand Ther 29(1):3-11; verschil tussen handtherapie en injectie NIET significant, combinatie wel beter dan elk apart; geen NNT van 3. | Peters-Veluthamaningal C et al. (2009), Goel R &amp; Abzug JM (2015), Cook JL &amp; Purdam CR (2009), Ilyas AM et al. (2007) en Backstrom KM (2002) — in dit dossier niet opgehaald.'},
  // ─────────────────────────────────────────────────────────────────
  // DISCECTOMIE L4-L5 (DISC)
  // Evidence: Oosterhuis 2014 (Cochrane, 22 RCT's), Gilmore 2014 (SR),
  // Carragee 1996 + 1999 (activiteitsbeperkingen), Yin 2018 (recidief per niveau),
  // Miller 2018 (annulusdefect). Alle zes live geverifieerd via PubMed.
  // LET OP: de revalidatieliteratuur is NIET niveau-specifiek. L4-L5 bepaalt welke
  // wortel je opvolgt, niet welk oefenprogramma je geeft.
  // ─────────────────────────────────────────────────────────────────
  disc:{
    id:'disc', title:'Discectomie L4-L5', subtitle:'Postoperatief revalidatieprotocol na discectomie op niveau L4-L5 (open, micro of endoscopisch)',
    color:'#0d9488',
    phases:[
      {
        label:'Fase 1', title:'Wondgenezing & Mobiliseren', weeks:'Week 0–2',
        evidence:'<strong>Deze fase is geen trainingsfase, en dat is een bevinding, geen keuze.</strong> In de Cochrane-review van 22 gerandomiseerde studies met 2503 deelnemers waren revalidatieprogramma&#39;s die <strong>onmiddellijk na de operatie</strong> startten <strong>niet effectiever</strong> dan hun controlebehandeling (Oosterhuis et al., 2014 — Cochrane). <em>De overall bewijskwaliteit van die review is laag tot zeer laag; dat geldt voor álle uitspraken hieronder.</em> Een systematische review van vier studies vond <em>zeer laag</em> bewijs dat oefening vóór én na de operatie de pijn, de tijd tot functionele mijlpalen en het werkverzuim kan verkorten (Gilmore et al., 2014 — Physiotherapy). <em>Uit diezelfde review: er is geen duidelijk voordeel én geen aantoonbare schade van transfers via buiklig tegenover zijlig — de discussie over dé juiste transfertechniek heeft dus geen basis.</em> Doel van deze fase is veilig mobiliseren, wondzorg en educatie — <em>niet belastbaarheid opbouwen.</em>',
        goals:['Zelfstandig en pijngestuurd in en uit bed komen','Wond droog en reactieloos houden','Neurologische status van de L5- en L4-wortel vastleggen als uitgangswaarde','Patiënt begrijpt wat wél en niet onderbouwd is aan beperkingen','Geleidelijk opbouwen van wandelen binnen de pijngrens'],
        exercises:[
          {name:'Transfers bed–stand (log roll of zijlig)',params:[['Freq','elke transfer'],['Begeleiding','eerste dagen met toezicht']],note:'Gilmore et al. (2014) vond géén duidelijk voordeel en géén schade van buiklig tegenover zijlig als transfermethode. Kies wat voor deze patiënt comfortabel en veilig is; er is geen bewijs dat één techniek de wond of het litteken beschermt.',cat:'manueel'},
          {name:'Wandelen — korte blokjes',params:[['Start','5–10 min'],['Freq','3–5×/dag'],['Opbouw','pijngestuurd verlengen']],note:'Wandelen is de veiligste vroege belasting. Opbouw op geleide van been- en rugpijn, niet op een vast schema — klinische richtlijn.',cat:'cardio'},
          {name:'Enkelpompen & circulatieoefeningen',params:[['Reps','15–20'],['Freq','elk uur wakker']],note:'Tegen veneuze stase in de eerste dagen. Klinische richtlijn; in dit dossier niet tegen een bron gelegd.',cat:'mobiliteit'},
          {name:'Neurologische controle L5 en L4',params:[['Freq','bij start en wekelijks'],['L5','extensie grote teen, sensibiliteit voetrug'],['L4','quadriceps, kniepeesreflex, mediale onderbeen']],note:'Bij een herniatie op L4-L5 is meestal de L5-wortel aangedaan (paramediaan), bij een ver-laterale herniatie de L4-wortel. Leg de uitgangswaarde vast, zodat je een NIEUW uitvalspatroon kunt onderscheiden van restuitval. Anatomische kennis, geen bronclaim.',cat:'test'},
          {name:'Educatie — wat de beperkingen wél en niet zijn',params:[['Duur','15–20 min'],['Materiaal','uitleg + schriftelijke meegave']],note:'Bespreek eerlijk dat strikte til- en bukverboden zwak onderbouwd zijn (zie fase 2), maar dat de eerste weken vooral om wondgenezing en pijngeleide opbouw gaan. Vraag na welke instructies de chirurg gaf en volg die; een protocol vervangt geen operatieverslag.',cat:'manueel'},
          {name:'Ademhaling & rompontspanning in ruglig',params:[['Reps','8–10'],['Sets','2–3'],['Freq','2×/dag']],note:'Tegen beschermende rompspanning. Klinische richtlijn.',cat:'mobiliteit'}
        ],
        criteria_go:['Wond droog, geen tekenen van infectie','Zelfstandige transfers zonder hulp','15 min aaneengesloten kunnen wandelen','Geen nieuwe of toenemende neurologische uitval','Pijn beheersbaar met de afgesproken medicatie'],
        criteria_stop:['Toenemende beenpijn of nieuw krachtverlies → chirurgconsult vóór verdere opbouw'],
        redflags:['Blaas- of darmstoornissen, rijbroekanesthesie → cauda equina, SPOEDVERWIJZING','Wondlekkage, roodheid, koorts → infectie of liquorlekkage, chirurgconsult','Plots hevige recidiverende beenpijn → verdenking herherniatie, chirurgconsult']
      },
      {
        label:'Fase 2', title:'Belastbaarheid & Activiteitenhervatting', weeks:'Week 2–6',
        evidence:'<strong>Strikte activiteitsbeperkingen zijn zwakker onderbouwd dan hun gebruik doet vermoeden.</strong> In twee opeenvolgende prospectieve reeksen kregen patiënten na beperkte open discectomie <strong>géén enkele postoperatieve beperking</strong> en werden ze aangemoedigd zo snel mogelijk alles te hervatten. In de grootste reeks (152 patiënten) hervatte <strong>98%</strong> het werk, met een gemiddeld verzuim van <strong>1,2 weken</strong>; ongeveer een derde was binnen een week terug. Zeer vroege werkhervatting hing <strong>niet</strong> samen met recidiverende ischias, heroperatie of de uiteindelijke uitkomst. Mogelijke herherniatie trad op bij 11,2% en heroperatie bij 5,3% — vergelijkbaar met wat elders bij patiënten mét beperkingen wordt gerapporteerd (Carragee et al., 1999 — Spine; eerdere reeks van 50 patiënten: Carragee et al., 1996 — Spine). <em>Belangrijke beperking: dit zijn prospectieve cohorten ZONDER controlegroep. Ze tonen dat het loslaten van beperkingen veilig lijkt, niet dat het beter is dan beperken. Volg altijd de instructies van de chirurg — die kent het annulusdefect, en dat blijkt hieronder te tellen.</em>',
        goals:['Dagelijkse activiteiten hervatten binnen de pijngrens','Wandelduur opbouwen naar 30–45 minuten','Rompspieren weer inschakelen in functionele houdingen','Werkhervatting concreet plannen met de patiënt','Angst voor bewegen bespreekbaar maken en verminderen'],
        exercises:[
          {name:'Wandelen — opbouw naar 30–45 min',params:[['Duur','20 → 45 min'],['Freq','dagelijks'],['Tempo','comfortabel']],note:'Het best verdragen opbouwmiddel in deze fase. Klinische richtlijn.',cat:'cardio'},
          {name:'Sit-to-stand met rompcontrole',params:[['Reps','8–12'],['Sets','2–3'],['Freq','dagelijks']],note:'Functionele belasting van heup en romp zonder eindstandige flexie. Klinische richtlijn.',cat:'kracht'},
          {name:'Bekkenkanteling & lage rompactivatie',params:[['Reps','10'],['Hold','5 sec'],['Sets','3']],note:'Rustige heractivatie in ruglig. De specifieke keuze voor diepe rompspieren boven algemene oefening is bij deze populatie niet aangetoond — zie fase 3.',cat:'stabiliteit'},
          {name:'Heupscharnier oefenen (zonder gewicht)',params:[['Reps','10–12'],['Sets','3'],['Aandacht','beweging uit de heup, romp neutraal']],note:'Voorbereiding op tillen. Dat een neutrale rug beschermt tegen herherniatie is klinische redenering, in dit dossier niet onderbouwd.',cat:'kracht'},
          {name:'Tillen — graduele blootstelling',params:[['Start','licht huishoudelijk gewicht'],['Opbouw','wekelijks verhogen op geleide van klachten']],note:'Carragee (1996, 1999) liet beperkingen volledig los zonder meer complicaties, maar dat waren ongecontroleerde reeksen. Bespreek de opbouw met de patiënt én toets ze aan de instructies van de chirurg.',cat:'kracht'},
          {name:'Werkhervattingsgesprek',params:[['Timing','vanaf week 2'],['Inhoud','taakanalyse, aangepast werk, opbouwschema']],note:'In de reeks van Carragee (1999) bedroeg het gemiddelde verzuim 1,2 weken zonder beperkingen. Dat cijfer komt uit een cohort zonder controlegroep en uit een ander zorgsysteem; gebruik het als gespreksopener, niet als norm.',cat:'manueel'}
        ],
        criteria_go:['30 min aaneengesloten wandelen zonder toename van beenpijn','Dagelijkse activiteiten grotendeels zelfstandig','Geen nieuwe neurologische uitval','Patiënt durft de romp functioneel te belasten','Werkhervattingsplan besproken'],
        criteria_stop:['Toenemende radiculaire pijn bij opbouw → opbouw terugschroeven en arts contacteren'],
        redflags:['Nieuwe uitval of blaasstoornissen → SPOED','Plotse hevige beenpijn na tillen → verdenking herherniatie']
      },
      {
        label:'Fase 3', title:'Actieve Oefentherapie', weeks:'Week 6–12',
        evidence:'<strong>Dit is de fase waarin de literatuur wél effect laat zien — met twee bevindingen die het protocol goedkoper maken.</strong> Oefenprogramma&#39;s die <strong>vier tot zes weken</strong> na de operatie starten, gaven tegenover geen behandeling minder pijn (SMD -0,90; 95% BI -1,55 tot -0,24; 5 studies, 272 deelnemers) en betere functie (SMD -0,67; -1,22 tot -0,12; 4 studies, 252 deelnemers) op <strong>korte termijn</strong>. <strong>Op lange termijn was er géén verschil meer</strong> (SMD -0,22; -0,49 tot 0,04). Hoogintensieve programma&#39;s deden het iets beter dan laagintensieve (pijn: gemiddeld verschil -10,67; -17,04 tot -4,30). <strong>En het punt dat de patiënt direct raakt: begeleide en thuisoefenprogramma&#39;s verschilden NIET significant</strong>, niet voor pijn (SMD -0,76; -2,04 tot 0,53) en niet voor functie (SMD -0,36; -0,88 tot 0,15) (Oosterhuis et al., 2014 — Cochrane). <em>Bewijskwaliteit laag tot zeer laag. Geruststellend en expliciet vermeld: géén van de studies rapporteerde dat oefenen het aantal heroperaties verhoogde.</em>',
        goals:['Progressieve krachtopbouw van romp, heup en benen','Uithouding opbouwen richting werk- en sporteisen','Bewegingsangst verder afbouwen','Zelfstandig een thuisprogramma kunnen uitvoeren','Pijn en functie objectiveren met een vragenlijst'],
        exercises:[
          {name:'Romp- en heupkrachttraining (progressief)',params:[['Reps','8–12'],['Sets','3'],['Freq','2–3×/week'],['Intensiteit','progressief op geleide van klachten']],note:'Hoogintensief deed het in de Cochrane-review iets beter dan laagintensief, maar op zeer laag bewijs en alleen op korte termijn. Bouw op zonder de belasting tot doel op zich te maken.',cat:'kracht'},
          {name:'Deadlift-patroon met licht gewicht',params:[['Reps','8–10'],['Sets','3'],['Belasting','licht, progressief']],note:'Functionele tilbelasting. De specifieke keuze voor dit patroon boven andere krachtoefeningen is bij deze populatie niet onderzocht — klinische richtlijn.',cat:'kracht'},
          {name:'Thuisoefenprogramma',params:[['Freq','dagelijks of om de dag'],['Duur','20–30 min'],['Opvolging','controle om de 2–3 weken']],note:'Begeleide en thuisprogramma&#39;s verschilden in de Cochrane-review NIET significant voor pijn of functie. Een thuisprogramma is dus een verdedigbare keuze die de patiënt tijd en geld bespaart; kies begeleiding wanneer uitvoering of vertrouwen daarom vraagt.',cat:'kracht'},
          {name:'Aerobe training (fiets, wandelen, zwemmen)',params:[['Duur','20–40 min'],['Freq','3–5×/week'],['Intensiteit','matig']],note:'Uithouding en algemene belastbaarheid. Klinische richtlijn.',cat:'cardio'},
          {name:'Neurodynamische mobilisatie L5/S1',params:[['Reps','8–10'],['Sets','2–3'],['Vorm','glijden, niet spannen']],note:'Bij restklachten van de zenuwwortel. Het onderzoek naar neurale mobilisatie betreft nek- en armpijn, niet de lumbale wortel na discectomie — overdracht is klinische redenering.',cat:'neuro'},
          {name:'Functionele vragenlijst (ODI of PSK)',params:[['Freq','bij start van de fase en om de 4 weken']],note:'Objectiveert het beloop en maakt stagnatie zichtbaar. De keuze van het instrument is praktijkafspraak.',cat:'test'}
        ],
        criteria_go:['Pijn in rug en been stabiel of afnemend bij toenemende belasting','Krachttraining 2–3×/week volgehouden zonder klachtentoename','45–60 min aaneengesloten belastbaar','Thuisprogramma zelfstandig correct uitgevoerd','Geen nieuwe neurologische uitval'],
        criteria_stop:['Klachten nemen bij elke opbouw toe → heroverweeg beleid en overleg met de arts','Stagnerende vragenlijstscore na 8 weken → multidisciplinaire evaluatie'],
        redflags:['Nieuwe motorische uitval → chirurgconsult']
      },
      {
        label:'Fase 4', title:'Werk- & Sportgerichte Opbouw', weeks:'Week 12–20',
        evidence:'<strong>Let op de reikwijdte van wat oefentherapie hier nog oplevert.</strong> In dezelfde Cochrane-review was er op <strong>lange termijn géén verschil</strong> in functie tussen oefenen en niet oefenen (SMD -0,22; 95% BI -0,49 tot 0,04; 3 studies, 226 deelnemers). Dat pleit niet tégen doorgaan, maar wel tegen de belofte dat verdere therapie de eindsituatie verandert. <strong>Wat wél sneller ging:</strong> multidisciplinaire revalidatie gecoördineerd door een arts-adviseur leidde tot <strong>snellere werkhervatting</strong> dan gebruikelijke zorg, op laag bewijs (Oosterhuis et al., 2014 — Cochrane). <em>Bij aanhoudende werkgerelateerde belemmeringen is de meerwaarde dus eerder organisatorisch — afstemming met arbeidsgeneesheer en werkgever — dan oefentechnisch.</em> Sportspecifieke opbouw en de drempels hieronder zijn <em>praktijkafspraken zonder bron in dit dossier.</em>',
        goals:['Belastbaarheid afstemmen op de concrete werkeisen','Sportspecifieke bewegingen opbouwen bij sporters','Werkhervatting realiseren, zo nodig aangepast','Zelfvertrouwen in de rug bij zware taken','Terugvalplan opstellen'],
        exercises:[
          {name:'Werksimulatie — taakspecifiek',params:[['Inhoud','tillen, dragen, bukken, langdurig zitten of staan'],['Freq','2×/week'],['Opbouw','naar de reële werkeis']],note:'Stem af op de werkelijke taken van deze patiënt. Multidisciplinaire coördinatie met een arts-adviseur gaf in de Cochrane-review snellere werkhervatting (laag bewijs).',cat:'kracht'},
          {name:'Zware tilopbouw',params:[['Reps','6–10'],['Sets','3–4'],['Belasting','richting werkeis']],note:'Opbouw richting wat het werk vraagt. De gehanteerde belastingsstappen zijn praktijkafspraak.',cat:'kracht'},
          {name:'Rompuithouding onder belasting',params:[['Hold','30–60 sec'],['Sets','3'],['Varianten','plank, side plank, bird dog']],note:'Uithouding voor langdurige houdingen. Klinische richtlijn.',cat:'stabiliteit'},
          {name:'Sportspecifieke opbouw',params:[['Freq','2–3×/week'],['Opbouw','techniek → volume → intensiteit']],note:'Enkel bij sporters. Er is in dit dossier geen bron over sporthervatting na discectomie; de opbouw is klinische redenering.',cat:'neuro'},
          {name:'Overleg arbeidsgeneesheer / werkgever',params:[['Timing','vanaf week 12'],['Inhoud','aangepast werk, opbouwschema, knelpunten']],note:'De sterkste winst in deze fase is organisatorisch: gecoördineerde multidisciplinaire zorg gaf snellere werkhervatting dan gebruikelijke zorg.',cat:'manueel'},
          {name:'Terugvalplan opstellen',params:[['Duur','20 min'],['Inhoud','waarschuwingstekens, eerste stappen, wanneer contact opnemen']],note:'Schriftelijk meegeven. Klinische richtlijn.',cat:'manueel'}
        ],
        criteria_go:['Werkeisen gesimuleerd zonder klachtentoename de dag nadien','Werkhervatting gestart of concreet gepland','Sportspecifieke bewegingen pijnvrij bij sporters','Patiënt kent de waarschuwingstekens','Vragenlijstscore verbeterd of stabiel op een aanvaardbaar niveau'],
        criteria_stop:['Werkhervatting mislukt ondanks aanpassing → multidisciplinair overleg'],
        redflags:['Recidiverende radiculaire pijn bij tillen → chirurgconsult']
      },
      {
        label:'Fase 5', title:'Onderhoud & Recidiefpreventie', weeks:'Maand 5+',
        evidence:'<strong>Recidiefcijfers — en het enige cijfer in dit protocol dat over L4-L5 zélf gaat.</strong> In een meta-analyse van <strong>percutane endoscopische</strong> lumbale discectomie bedroeg de herherniatie <strong>3,6%</strong> (95% BI 3,0–4,3%). Per niveau: <strong>2,7% op L4-L5</strong>, 3,1% op L5-S1 en 5,4% op de hogere lumbale niveaus. <strong>61,7% van de recidieven trad op binnen zes maanden</strong> na de operatie. Hogere leeftijd (≥ 50 jaar, 4,3% tegenover 2,7%) en een BMI ≥ 25 (4,8% tegenover 1,5%) gingen samen met meer recidief (Yin et al., 2018 — Pain Physician). <em>Let op: deze cijfers gelden voor de ENDOSCOPISCHE techniek en komen grotendeels uit retrospectieve studies van matige kwaliteit; bij open of microdiscectomie kunnen ze anders liggen.</em> Een <strong>groot annulusdefect</strong> verhoogde in zeven vergelijkende studies met 1653 patiënten het risico op symptoomrecidief (odds ratio 2,5; 95% BI 1,3–4,5) en op heroperatie (2,3; 1,5–3,7) (Miller et al., 2018 — Spine). <em>Dat is een chirurgisch gegeven dat de kinesitherapeut niet kan beïnvloeden, maar dat wél in het operatieverslag kan staan en de verwachtingen mag sturen.</em>',
        goals:['Krachttraining structureel volhouden','Gewicht en algemene conditie bespreken waar relevant','Vroege tekenen van recidief herkennen','Werk en sport duurzaam volhouden','Zelfredzaamheid bij een opflakkering'],
        exercises:[
          {name:'Onderhoudskrachttraining',params:[['Freq','2×/week'],['Inhoud','romp, heup, benen'],['Duur','levenslang aanhouden']],note:'De frequentie van 2×/week is een praktijkafspraak; de Cochrane-review onderzocht geen onderhoudsfrequentie.',cat:'kracht'},
          {name:'Aerobe training volhouden',params:[['Duur','30 min'],['Freq','3–5×/week']],note:'Een BMI ≥ 25 ging in Yin et al. (2018) samen met meer recidief (4,8% tegenover 1,5%). Dat is een SAMENHANG in retrospectieve data, geen bewijs dat afvallen het recidief verlaagt — breng het zo ook bij de patiënt.',cat:'cardio'},
          {name:'Zelfcontrole op recidieftekens',params:[['Freq','doorlopend'],['Aandacht','terugkerende beenpijn, krachtverlies, gevoelsstoornis']],note:'Bijna twee derde van de recidieven trad in Yin et al. (2018) binnen zes maanden na de operatie op. De eerste maanden verdienen dus de meeste waakzaamheid.',cat:'test'},
          {name:'Tiltechniek onderhouden',params:[['Freq','periodiek opfrissen']],note:'Dat een bepaalde tiltechniek herherniatie voorkomt, is in dit dossier niet onderbouwd; Carragee zag zonder enige beperking geen verhoogd complicatiecijfer. Blijf het bespreken als comfort- en vertrouwensmaatregel.',cat:'kracht'},
          {name:'Jaarlijkse evaluatie',params:[['Freq','1×/jaar'],['Inhoud','vragenlijst, kracht, werkbelasting']],note:'Praktijkafspraak.',cat:'test'}
        ],
        criteria_go:['Onderhoudsprogramma zelfstandig volgehouden','Werk en sport op het gewenste niveau','Patiënt herkent recidieftekens','Geen functionele beperking in het dagelijks leven'],
        criteria_stop:['Terugkerende radiculaire klachten → opnieuw beoordelen, beeldvorming overwegen via de arts'],
        redflags:['Nieuwe uitval, blaas- of darmstoornissen → SPOED','Terugkerende beenpijn in hetzelfde patroon → verdenking herherniatie, arts contacteren']
      }
    ],
    refs:'Oosterhuis T et al. (2014) — Rehabilitation after lumbar disc surgery. Cochrane Database Syst Rev 2014(3):CD003007; 22 RCT&#39;s, 2503 deelnemers; onmiddellijk starten NIET effectiever, oefenen vanaf 4-6 weken wel op korte termijn maar niet op lange, begeleid = thuis, geen verhoogd aantal heroperaties; bewijskwaliteit laag tot zeer laag. | Gilmore SJ et al. (2014) — Physiotherapeutic interventions before and after surgery for degenerative lumbar conditions: systematic review. Physiotherapy 101(2):111-8; vier studies, zeer laag bewijs; geen voordeel of schade van buiklig tegenover zijlig bij transfers. | Carragee EJ et al. (1999) — Activity restrictions after posterior lumbar discectomy: 152 cases with no postoperative restrictions. Spine 24(22):2346-51; 98% werkhervatting, gemiddeld verzuim 1,2 weken, 11,2% mogelijke herherniatie, 5,3% heroperatie; GEEN controlegroep. | Carragee EJ et al. (1996) — Are postoperative activity restrictions necessary after posterior lumbar discectomy? Spine 21(16):1893-7; 50 patienten, gemiddeld verzuim 1,7 weken, 6% herherniatie. | Yin S et al. (2018) — Prevalence of recurrent herniation following percutaneous endoscopic lumbar discectomy: meta-analysis. Pain Physician 21(4):337-350; 3,6% totaal, 2,7% op L4-L5, 61,7% binnen zes maanden; ENDOSCOPISCHE techniek, grotendeels retrospectieve studies. | Miller LE et al. (2018) — Association of annular defect width after lumbar discectomy with risk of symptom recurrence and reoperation. Spine 43(5):E308-E315; groot defect: recidief OR 2,5 (1,3-4,5), heroperatie OR 2,3 (1,5-3,7).'
  },

  // ─────────────────────────────────────────────────────────────────
  // CARPAALTUNNELSYNDROOM (CTS)
  // Evidence: Page 2022 (Cochrane), Fernández-de-las-Peñas 2021 — in dit dossier niet opgehaald,
  // Walker 2000 (RCT neutraalspalk), Atroshi 2009 — in dit dossier niet opgehaald (endoscopisch vs open),
  // Marshall 2007 — in dit dossier niet opgehaald (injectie), Wehbé & Schlegel 2004 (glijtechnieken)
  // ─────────────────────────────────────────────────────────────────
  cts:{
    ...
    phases:[
      {
        ...
        evidence:'<strong>Polsspalk — de aangehaalde trial vergeleek iets anders.</strong> Walker et al. (2000) zetten <strong>nachtelijk dragen tegenover voltijds dragen</strong> van een neutrale polsspalk; er was <strong>géén controlegroep zonder behandeling</strong>, dus de uitspraak dat een spalk beter is dan geen behandeling kan er niet uit komen. Het ging bovendien om 21 patiënten waarvan er 17 de studie voltooiden, en de uitkomstmaten waren de Levine-vragenlijst en de distale latentie — <em>niet NRS of BCTQ-SSS, en de cijfers -2,1 en -0,5 komen er niet in voor.</em> Wat er wél in staat: de hele groep verbeterde, en <strong>voltijds dragen gaf een betere distale latentie dan enkel &#39;s nachts</strong> (motorisch 0,35 tegenover -0,07 ms; p = 0,04), al was de therapietrouw beperkt. <em>Marshall et al. (2007 — Cochrane), Fernández-de-las-Peñas et al. (2021) en Wehbé &amp; Schlegel (2004) met de drukreductie van 34% zijn in dit dossier niet opgehaald.</em>',
        ...
        exercises:[
          ...
          {name:'Neurale mobilisatie cervicaal — dubbele crush-syndroom uitsluiting',params:[['Sets','2'],['Reps','8'],['Richting','C6-C7 wortelmo bilisatie']],note:'Een deel van de CTS-patiënten heeft daarnaast een cervicale radiculopathie C6–C7 (double crush); het eerder vermelde aandeel van 15–20% is in dit dossier niet nagekeken. Screenen: ULTT1 voor n. medianus, Spurling-test, cervicale rotatie kracht. Bij positief: cervicale mobilisatie toevoegen aan protocol.',cat:'neuro'}
        ],
      ...
      },
      {
        ...
        evidence:'<em>De claim dat vroege mobilisatie superieur is aan immobilisatie na CTS-release wordt aan Huisstede et al. (2010) toegeschreven — maar die systematische review (Archives of Physical Medicine and Rehabilitation, GEEN Cochrane) besluit letterlijk dat er GEEN BEWIJS werd gevonden voor de werkzaamheid van pre- of postoperatieve behandelprogramma&#39;s, spalken inbegrepen. De claim is geschrapt.</em> Wat die review wel vond: matig bewijs dat chirurgie op middellange en lange termijn beter is dan spalken of ontstekingsremmers plus handtherapie, en géén bewijs dat een bepaalde operatietechniek beter is dan een andere. <em>Atroshi et al. (2009) met 11 tegenover 17 dagen en Bland (2007) zijn in dit dossier niet opgehaald; onmiddellijke vingermobilisatie blijft klinische richtlijn.</em>',
        ...
        exercises:[
          {name:'Vinger AROM — vroege mobilisatie (dag 1–3)',params:[['Start','dag 1 post-OK'],['Sets','3'],['Reps','10'],['Freq','4–6×/dag']],note:'Vroege vingermobilisatie is klinische richtlijn; Bland (2007) is in dit dossier niet opgehaald in carpaaltunnel na release. Volledige vuist maken + spreiden. Geen kracht — louter beweging. Controleer wond op bloeding voor start. Open release: verband niet verwijderen.',cat:'mobiliteit'},
      ...
      },
      {
        ...
        evidence:'<em>Dat handtherapie na CTS-release de grijpkracht en de BCTQ sneller verbetert dan geen therapie, wordt opnieuw aan Huisstede et al. (2010) toegeschreven, die juist GEEN bewijs vond voor postoperatieve behandelprogramma&#39;s. De claim is geschrapt.</em> Hervatting van zenuw- en peesglijden vanaf week 2 en littekenmassage vanaf week 3 tot 4 blijven <em>klinische richtlijn; Fernández-de-las-Peñas et al. (2021) en Shiels et al. (2016) zijn niet opgehaald.</em> <em>Het woord &quot;cruciaal&quot; voor het sensorisch herstel is daarmee niet onderbouwd.</em>',
        ...
        exercises:[
          {name:'Zenuwglijden n. medianus — intensief protocol (wk 2+)',params:[['Sets','4'],['Reps','12 per positie'],['Freq','4–5×/dag'],['Progressie','amplitude verhogen wekelijks']],note:'Na week 2: wond gesloten → grotere amplitudes mogelijk. Fernández-de-las-Peñas 2021 — in dit dossier niet opgehaald: dagelijkse frequentie zenuwglijding correleert met sensorisch herstelsnelheid (r=0.68). Elektrisch/schietend gevoel = normaal motorisch zenuwherstel (Tinel-progressie).',cat:'neuro'},
          ...
          {name:'Littekenmassage',params:[['Start','week 3–4 (wond volledig gesloten)'],['Duur','5 min'],['Freq','2–3×/dag'],['Richting','transversaal + circulair op littekenweefsel]']],note:'Littekenmassage in week 3 tot 4 wordt toegepast tegen palmaire overgevoeligheid; Shiels et al. (2016) is in dit dossier niet opgehaald. Technique: duim op litteken, zachte cirkels, progressief dieper. Verkleving met carpale ligamenten voorkomen. Pillar pain (palmaire pilaren): normaal tot week 6–8, afnemend.',cat:'manueel'},
          {name:'Grip krachttraining progressief',params:[['Wk 2–4','isometrisch, geen weerstand'],['Wk 4–6','lichte weerstand (Thera-Putty soft)'],['Wk 6–8','matige weerstand'],['Meting','jamar dynamometer elke 2 weken]']],note:'Let op: Huisstede et al. (2010) vond juist GEEN bewijs voor postoperatieve behandelprogramma&#39;s; het eerder vermelde cijfer van 35% meer gripkracht staat er niet in en is geschrapt. Krachtopbouw blijft klinische richtlijn. Pillar pain mag lichte oefening niet hinderen — onderscheid van wondpijn. Doel week 8: ≥ 60% contralateraal.',cat:'kracht'},
          {name:'Pincetgreep kracht & fijnmotoriek',params:[['Oefeningen','pinch meter, munten oprapen, knopen, schrijven'],['Sets','3'],['Reps','10–15'],['Freq','2×/dag]']],note:'Pincetgreep (tip-to-tip en lateraal) traag herstel na CTS — thenarspieren reïnnervatie neemt 3–6 maanden. Fijnmotorische training: pennyschuiven, muntenstapeling, trekken van knopen. Atroshi 2009 — in dit dossier niet opgehaald: dag tot fijnmotoriek = beste predictor RTW-timing.',cat:'kracht'},
      ...
      },
      {
        ...
        evidence:'<em>Atroshi et al. (2009) met een mediane werkhervatting van 11 tegenover 17 dagen, de 28 dagen bij manuele arbeid en de NICE-richtlijn (2022) over work hardening zijn geen van drie opgehaald in dit dossier.</em> <strong>Wat wel geverifieerd is:</strong> Huisstede et al. (2010) vond géén bewijs voor de werkzaamheid van postoperatieve behandelprogramma&#39;s — <em>niet alleen niet boven acht weken, maar in het algemeen. Dat pleit voor terughoudendheid met routinematige nabehandeling bij een ongecompliceerde release, en voor gerichte therapie enkel bij aanhoudende klachten.</em>',
        ...
        exercises:[
          ...
          {name:'Work hardening programma — functieherstel manuele beroepen',params:[['Duur','4–6 weken'],['Freq','3–5×/week'],['Setting','ergotherapeut + kinesitherapeut']],note:'Gesimuleerde werktaken: tillen, dragen, gereedschap, schrijven, computerwerk. Work hardening bij manuele beroepen is klinische richtlijn; de NICE-richtlijn (2022) is in dit dossier niet opgehaald en het eerder vermelde cijfer van 40% is geschrapt. Minimaal verplicht voor bouwvak, zorg, horeca.',cat:'neuro'},
          ...
          {name:'Ergonomie-programma definitief — recidief preventie',params:[['Sessie','45 min screeningsgesprek'],['Tools','ergonomisch adviesrapport'],['Follow-up','1 maand, 3 maanden, 12 maanden]']],note:'De eerder vermelde recidiefpercentages (3–10% open, 2–7% endoscopisch op vijf jaar) zijn in dit dossier niet nagekeken. Risicogroepen: manuele beroepen, zwaarlijvigheid, diabetes, hypothyreoïdie. Aanpak: ergonomische polspositie bij grip, trillingsreductie, reguliere pauzes, nachtspalk bij productiepieken.',cat:'neuro'},
        ...
        criteria_stop:['Grip < 75% na 16 weken → ergotherapeut intensief handrevalidatie (drempel is praktijkafspraak, niet onderbouwd)','BCTQ stagneert → multidisciplinaire evaluatie: re-compressie, CRPS, cervicale double-crush'],
    ...
    refs:'Walker WC et al. (2000) — Neutral wrist splinting in carpal tunnel syndrome: NIGHT-ONLY VERSUS FULL-TIME wear. Arch Phys Med Rehabil 81(4):424-9; 21 patienten, geen controlegroep zonder behandeling, uitkomstmaten Levine-vragenlijst en distale latentie. | Huisstede BM et al. (2010) — Carpal tunnel syndrome part II: effectiveness of surgical treatments. Arch Phys Med Rehabil 91(7):1005-24 (GEEN Cochrane); GEEN bewijs voor pre- of postoperatieve behandelprogramma&#39;s, spalken inbegrepen. | Page MJ et al. (2022), Fernandez-de-las-Penas C et al. (2015 en 2021), Atroshi I et al. (2009), Marshall SC et al. (2007), Wehbe MA &amp; Schlegel JM (2004), Bland JD (2007) en de NICE-richtlijn (2022) — in dit dossier niet opgehaald.'}
};
...
protocols.hsi = {id:'hsi',title:'Hamstring Blessure',subtitle:'Graad I–III hamstring strain — acute fase, progressief herstel en return to sprint',color:'#facc15',icon:'🦵',
  phases:[
    {label:'Fase 1',title:'Acute Fase & Pijncontrole',weeks:'Dag 0–5',
     evidence:'<strong>POLICE-principe</strong> (Bleakley et al., 2012 — BJSM): <em>een editoriaal, geen trial; in dit dossier niet opgehaald.</em> <strong>Gradering</strong> stuurt de prognose: Graad I (&lt; 10% vezels, 1–2 weken), Graad II (10–50%, 3–8 weken), Graad III (&gt; 50%, ≥ 8–16 weken) — <em>de tijdvensters zijn klinische richtlijn, in dit dossier niet onderbouwd.</em> <em>Dat MRI de gouden standaard voor gradatie is, staat NIET in Ekstrand et al. (2011); dat is een epidemiologisch cohort.</em> Wat daar wel in staat: hamstrings zijn met 37% de grootste groep spierletsels in het profvoetbal, <strong>16% zijn herletsels</strong> en die veroorzaken significant langere afwezigheid. <strong>Vroege isometrische belasting</strong> (dag 1–2): de aangehaalde publicatie is een <strong>brief aan de redactie in de NEJM</strong> (Bayer et al., 2017 — niet Orthop J Sports Med), waarvan PubMed geen abstract levert; <em>de claim kon dus niet tegen de bron gelegd worden.</em> <strong>Agressief rekken vermijden</strong> in de acute fase is <em>klinische richtlijn.</em>',
    ...
    {label:'Fase 2',title:'Subacute Krachtherstel',weeks:'Week 1–4',
     evidence:'<strong>Progressieve isotonische belasting</strong> boven passieve rust (Järvinen et al., 2005), het <strong>L-protocol</strong> en de superioriteit ervan boven snelle excentrische contracties, en het verhoogde reruptuurrisico bij te vroege Nordic Hamstring (Askling et al., 2003): <em>alle drie in dit dossier niet opgehaald.</em> <em>Let op: het artikel van Askling in KSSTA 2013 dat in het refs-veld staat, gaat over TOTALE PROXIMALE RUPTUREN met chirurgisch herstel (bewijsniveau V) en bevat geen terugkeercriteria voor spierletsel.</em> <strong>Criteriumgestuurde progressie</strong> boven tijdgestuurde, met pijnvrij bij 3/10 als drempel (de rest van dit protocol hanteert 3/10; de eerder vermelde 5/10 was daarmee in tegenspraak): <em>klinische richtlijn zonder bron.</em>',
    ...
    {label:'Fase 3',title:'Loophervatting & Excentrische Opbouw',weeks:'Week 3–8',
     evidence:'<strong>Nordic Hamstring — let op de uitkomstmaat.</strong> De aangehaalde RCT bij 579 <strong>amateur</strong>voetballers onderzocht <strong>primaire preventie, geen herletsel</strong>: de incidentie daalde van 0,8 naar 0,25 per 1000 spelersuren, odds ratio 0,282 (95% BI 0,110–0,721; p = 0,005), dus ongeveer <strong>72%</strong> minder blessures — <em>die 72% is onze omrekening van de odds ratio en staat niet letterlijk in de bron</em> (van der Horst et al., 2015 — AJSM). <em>Het eerder vermelde cijfer van 51% hoort bij een andere studie (van Dyk et al., 2019) en is hier geschrapt. Ook weggelaten: in de ERNST van de blessures werd géén statistisch significant verschil gevonden.</em> <strong>Graduele loophervatting</strong> en de drempel van 3/10 pijn: <em>klinische richtlijn.</em> <strong>Snelheid als risicofactor</strong> (Dorn et al., 2012): <em>in dit dossier niet opgehaald.</em> <em>Dat prematuur terugkeren naar sprint de meest voorkomende oorzaak van recidief is, staat niet in Ekstrand et al. (2011); wat daar wel in staat is dat 16% van de spierletsels herletsels zijn met langere afwezigheid.</em> <strong>LSI ≥ 90%</strong> is een <em>praktijkafspraak zonder bron.</em>',
    ...
    {label:'Fase 4',title:'Return to Sport & Sprinthervatting',weeks:'Week 6–16',
     evidence:'<strong>Multifactorieel terugkeermodel</strong> (kracht, sportspecifieke tests, psychologische gereedheid, tijd) is <em>klinische richtlijn.</em> <em>Het cijfer dat vroege terugkeer onder 3 weken 30% recidief geeft (Orchard et al., 2005), de drie H-testen die aan Askling et al. (2013) worden toegeschreven, en de 10/10-regel zijn in dit dossier geen van alle opgehaald — de KSSTA-publicatie van Askling uit 2013 gaat bovendien over totale proximale rupturen na chirurgie en bevat die testen niet.</em> <strong>Onderhoud van de Nordic Hamstring:</strong> de preventieve winst gold in de trial voor een programma van 25 sessies over 13 weken met 91% therapietrouw (van der Horst et al., 2015); <em>dat het effect wegvalt bij stoppen is een redelijke maar niet in die trial onderzochte gevolgtrekking.</em>',
     goals:['Maximale sprint (100%) pijnvrij','Hamstring LSI ≥ 90%','H-test en actieve rektest pijnvrij (praktijkafspraak; de toeschrijving aan Askling 2013 klopt niet)','Sport-specifieke drills volledig','Nordic hamstring onderhoudsprogramma gestart'],
     exercises:[
       ...
       {name:'Nordic Hamstring (onderhoud)',cat:'kracht',params:[['Reps','6–8'],['Sets','3'],['Freq','1–2×/week']],note:'Preventief programma voor de rest van het seizoen. Het aangetoonde effect betreft PRIMAIRE preventie, niet herletsel: bij 579 amateurvoetballers daalde de incidentie van 0,8 naar 0,25 per 1000 spelersuren (odds ratio 0,282; van der Horst 2015). Het eerder vermelde cijfer van 51% hoort bij van Dyk 2019 en betreft hamstringletsel in het algemeen.'},
       {name:'H-test (toeschrijving aan Askling niet bevestigd)',cat:'test',params:[['LSI','≥ 90%'],['Pijn','0/10']],note:'Patiënt staand, been optillen maximaal (actieve hip flexie met gestrekte knie). Pijnvrij + ≥ 90° wordt als terugkeercriterium gebruikt — praktijkafspraak. De publicatie van Askling in KSSTA 2013 gaat over totale proximale rupturen na chirurgie en bevat deze test niet; de bedoelde bron is in dit dossier niet opgehaald.'},
     ],
     criteria_go:['Sprint 100% pijnvrij ≥ 3 sessies','Hamstring LSI ≥ 90%','H-test pijnvrij','≥ 3–8 wkn herstelperiode (graad II), ≥ 8–16 wkn (graad III) — praktijkafspraak, gelijkgetrokken met fase 1 en de beschrijving'],
  ...
  refs:'Ekstrand J et al. (2011) — Epidemiology of muscle injuries in professional football (soccer). Am J Sports Med 39(6):1226-32; hamstrings 37% van de spierletsels, 16% herletsels. | van der Horst N et al. (2015) — Preventive effect of the nordic hamstring exercise in AMATEUR soccer players. Am J Sports Med 43(6):1316-23; PRIMAIRE preventie, odds ratio 0,282, geen effect op ernst. | Askling CM et al. (2013) — <strong>Total proximal hamstring ruptures</strong>: clinical and MRI aspects including guidelines for postoperative rehabilitation. Knee Surg Sports Traumatol Arthrosc 21(3):515-33; bewijsniveau V, GEEN terugkeercriteria voor spierletsel. | Bayer ML et al. (2017) — Early versus delayed rehabilitation after acute muscle injury. <strong>N Engl J Med</strong> 377(13):1300-1 (correspondentie, geen abstract in PubMed). | Dorn TW et al. (2012) — Muscular strategy shift in human running. J Exp Biol; in dit dossier niet opgehaald. | Bleakley CM et al. (2012) — PRICE needs updating, should we call POLICE? BJSM; editoriaal, in dit dossier niet opgehaald. | Jarvinen TA et al. (2005), Askling CM et al. (2003) en Orchard J et al. (2005) — in dit dossier niet opgehaald. | van Dyk N et al. (2019) — Including the Nordic hamstring exercise in injury prevention programmes halves the rate of hamstring injuries. Br J Sports Med 53(21):1362-70; 15 studies, 8459 sporters, RR 0,49, reductie TOT 51% — hamstringletsel in het algemeen, niet herletsel.'};
...
protocols.elb = {id:'elb',title:'Laterale Epicondylalgie',subtitle:'Tennis Elbow — conservatief revalidatieprotocol voor de pees-aanhechting van de extensor carpi radialis brevis',color:'#c084fc',icon:'🎾',
  phases:[
    {label:'Fase 1',title:'Pijnmanagement & Isometrische Opbouw',weeks:'Week 1–4',
     evidence:'<strong>Laterale epicondylalgie (LE)</strong> is een tendinopathie van voornamelijk de <em>extensor carpi radialis brevis</em> (ECRB) ter hoogte van de laterale epicondyl. Dat het beeld degeneratief is zonder primaire inflammatie is <em>klinisch breed gedragen; de aangehaalde review (Coombes et al., 2015 — JOSPT) is een narratief overzicht van bewijs én expert opinion, dat zelf stelt dat de pathofysiologie onvoldoende begrepen is.</em> <strong>Afwachten:</strong> in de trial bij 198 patiënten was kinesitherapie de eerste zes weken beter dan afwachten, maar op 52 weken was er <strong>géén verschil</strong> meer en meldde het merendeel van beide groepen een goede uitkomst (Bisset et al., 2006 — <strong>BMJ</strong>, niet the Lancet). <em>Het eerder vermelde herstelpercentage van 78% staat er niet in.</em> In de Nederlandse trial bedroeg het slaagpercentage op 52 weken 91% na kinesitherapie, 83% na afwachten en 69% na injectie — het verschil tussen kinesitherapie en afwachten was <strong>niet significant</strong> (Smidt et al., 2002 — Lancet). <strong>Corticosteroïdinjectie:</strong> snel effect op zes weken (slaagpercentage 92%) maar na één jaar <strong>slechter dan placebo</strong>: 83% tegenover 96% herstel en 54% tegenover 12% herval (Coombes et al., 2013 — <strong>JAMA</strong>, niet the Lancet). <em>Wat in de app ontbrak: in diezelfde trial gaf kinesitherapie na één jaar géén significant verschil (91% tegenover 88%; p = 0,56).</em> <strong>Isometrische polsextensie</strong> steunt op onderzoek aan de <strong>patellapees</strong> (Rio et al., 2015); <em>overdracht naar de elleboog is klinische redenering.</em>',
     ...
     exercises:[
       {name:'Isometrische wrist extension',cat:'kracht',params:[['Hold','30–45 sec'],['Kracht','50–70% max'],['Sets','4'],['Rust','60 sec'],['Freq','dagelijks']],note:'Zittend, onderarm op tafel, pols in neutrale positie. Druk dorsumzijde hand tegen wand of contralaterale hand. Houd 30–45 sec. Pijn ≤ 3/10. Het pijnremmende effect van isometrie werd aan de patellapees onderzocht (Rio 2015); duur, intensiteit en het interval van 6 uur zijn praktijkafspraken zonder bron.'},
       ...
       {name:'Neurale mobilisatie (radialis)',cat:'mobiliteit',params:[['Reps','10'],['Sets','2']],note:'Neurodynamica nervus radialis: schouderabductie 90°, elleboogextensie, pols flexie + ulnaire deviatie. Of sensitisatie van de nervus radialis frequent met LE samengaat, is in dit dossier niet nagekeken.'},
     ...
     criteria_go:['NRS ≤ 3/10 bij isometrische test','Knijpkracht ≥ 50% contralateraal (praktijkafspraak, niet onderbouwd)','Begrepen belastingsmanagement (provocerende taken vermijden of aanpassen)'],
    ...
    {label:'Fase 2',title:'Excentrische & Isotone Peestraining',weeks:'Week 3–10',
     evidence:'<strong>Excentrische training van de pols-extensoren.</strong> De aangehaalde trial telde <strong>slechts 21 patiënten</strong> (11 tegenover 10) en voegde de oefening met de rubberen staaf TOE aan de standaardbehandeling in plaats van ze ermee te vergelijken. De verbeteringen waren wel duidelijk: VAS 81% tegenover 22% (p = 0,002), DASH 76% tegenover 13% (p = 0,01), drukgevoeligheid 71% tegenover 5% en kracht 79% tegenover 15% (Tyler et al., 2010 — <strong>J Shoulder Elbow Surg</strong>, niet JOSPT; behandelduur 7,2 en 7,0 weken, niet zes). <em>Bij 21 deelnemers blijft de schatting onnauwkeurig.</em> <strong>Heavy Slow Resistance</strong> werd onderzocht aan de <strong>achillespees</strong> (Beyer et al., 2015); <em>de gelijkwaardigheid aan excentrisch alleen geldt daar, niet aangetoond aan de elleboog.</em> <strong>Kinetische keten:</strong> Coombes et al. (2015) noemen nekpijn, peesscheuren en centrale sensitisatie als mogelijke prognostische factoren en stellen een <em>preliminair</em> algoritme voor; <em>dat schouder- en grijpkracht frequent deficiënt zijn, staat in die vorm niet in het abstract en is klinische redenering.</em>',
     goals:['PRTEE ≤ 40/100 (praktijkafspraak, niet onderbouwd)','Knijpkracht ≥ 75% contralateraal (praktijkafspraak, niet onderbouwd)','Excentrische wrist extension pijnvrij','Grijpkracht dagelijkse activiteiten pijnvrij','Schouder- en polsstabilisatie genormaliseerd'],
     exercises:[
       ...
       {name:'Wrist curl (concentrisch pols flexie)',cat:'kracht',params:[['Reps','15'],['Sets','3']],note:'Handhaving flexor-extensor balans. Ook de flexoren meetrainen — klinische richtlijn; een flexordeficit bij LE is in dit dossier niet onderbouwd.'},
       {name:'Schouderstabilisatie (scapulaire retractie)',cat:'kracht',params:[['Reps','15'],['Sets','3']],note:'Row, W-Y oefeningen. Optimalisatie van de proximale keten — klinische richtlijn; het eerder vermelde percentage van 35% had geen bron en is geschrapt.'},
     ],
     criteria_go:['PRTEE ≤ 40/100 (praktijkafspraak, niet onderbouwd)','Knijpkracht ≥ 75% contralateraal (praktijkafspraak, niet onderbouwd)','Excentrische test NRS ≤ 3 én NRS 0 volgende ochtend'],
     criteria_stop:['PRTEE stagneert 3 weken → manipulatie van de elleboog overwegen (praktijkafspraak; Vicenzino et al. 2007 is in dit dossier niet opgehaald)','Knijpkracht < 50% na week 6 → echo + orthopedie bij partiële ruptuur'],
     redflags:['Acute krachtdaling pols → peesruptuur ECRB → chirurgisch consult','Bleke, ingezonken of gedepigmenteerde huid ter hoogte van de laterale epicondyl → post-injectie vet- en huidatrofie (eerder stond hier ten onrechte geelkleuring)']},
    {label:'Fase 3',title:'Functionele Terugkeer & Sporthervatting',weeks:'Week 8–20+',
     evidence:'<strong>Sportspecifieke progressie</strong> bij tennissers, badmintonners en handarbeiders is <em>klinische richtlijn.</em> <strong>Slagarmtechniek</strong> en de invloed van elleboogextensie bij contact op de ECRB-belasting: <em>klinische redenering, in dit dossier niet nagekeken.</em> <strong>Racketaanpassingen</strong> (groter gripformaat, andere snaren, lagere spanning): <em>de citatie Rethnam &amp; Tugh (2010) heeft geen sleutel in het bronnenbestand en is in dit dossier niet opgehaald; het woord &quot;significant&quot; is daarom geschrapt.</em> <strong>Behandelduur van 6 tot 12 maanden</strong> en de PRTEE-drempels van 20 en 10 op 100 zijn <em>praktijkafspraken zonder bron.</em> Wat de literatuur wél zegt over het beloop: de prognose loopt sterk uiteen, van herstel na eenvoudig advies tot langdurige klachten ongeacht de behandeling (Coombes et al., 2015).',
     goals:['PRTEE < 20/100','Knijpkracht ≥ 90% contralateraal (praktijkafspraak, niet onderbouwd)','Sportspecifieke belasting pijnvrij (tennis, handarbeid)','Terugvalpreventie: onderhoud + ergonomie'],
     exercises:[
       {name:'Sportspecifieke drills (tennissers)',cat:'neuro',params:[['Oefening','Forehand techniek, service'],['Coach','techniekanalyse']],note:'Slagtiming en contactpunt optimaliseren. Dat een open stance forehand de elleboogbelasting vermindert, is in dit dossier niet nagekeken. Racketaanpassing evalueren.'},
       ...
       {name:'HSR onderhoud (3-1-3)',cat:'kracht',params:[['Reps','8–10'],['Sets','3'],['Freq','2×/week']],note:'Onderhoud peeskracht. Geleidelijk belasting ophogen — praktijkafspraak. Een lichaamsgewicht-equivalent is voor de polsextensoren niet realistisch en het preventieve effect komt uit onderzoek aan de achillespees (Beyer 2015), niet aan de elleboog.'},
     ...
     criteria_go:['PRTEE < 20/100','Knijpkracht ≥ 90% (praktijkafspraak, niet onderbouwd)','Sportactiviteit ≥ 30 min pijnvrij','NRS 0 volgende ochtend na sporttraining'],
     criteria_stop:['Terugval bij sporthervatting → techniekevaluatie + 2 weken intensifieer HSR','PRTEE > 40 na 12 weken → heroverweeg het beleid en overleg met de arts (de drempel en de termijn zijn praktijkafspraken zonder bron, en botsen met de verwachte behandelduur van 6–12 maanden elders in dit protocol)'],
     redflags:['Persistente klachten > 12 maanden ondanks optimale kinesitherapie → orthopedie: ECRB release, PRP, focale shockwave']},
  ],
  refs:'Bisset L et al. (2006) — Mobilisation with movement and exercise, corticosteroid injection, or wait and see for tennis elbow. <strong>BMJ</strong> 333(7575):939 (niet the Lancet). | Smidt N et al. (2002) — Corticosteroid injections, physiotherapy, or wait-and-see policy for lateral epicondylitis. Lancet 359(9307):657-62; op 52 weken 91% tegenover 83% tegenover 69%, verschil kinesitherapie-afwachten niet significant. | Coombes BK et al. (2013) — Corticosteroid injection, physiotherapy, or both. <strong>JAMA</strong> 309(5):461-9 (niet the Lancet); kinesitherapie gaf na een jaar geen significant verschil. | Coombes BK et al. (2015) — Management of lateral elbow tendinopathy: <strong>One Size Does Not Fit All</strong>. J Orthop Sports Phys Ther 45(11):938-49; narratieve review met expert opinion. | Tyler TF et al. (2010) — Isolated wrist extensor eccentric exercise. <strong>J Shoulder Elbow Surg</strong> 19(6):917-22 (niet JOSPT); n = 21. | Vicenzino B et al. (2007) — Specific manipulative therapy for tennis elbow. Man Ther; in dit dossier niet opgehaald.'};
...
protocols.mtss = {id:'mtss',title:'Shin Splints (MTSS)',subtitle:'Mediaal Tibiaal Stresssyndroom — belastingsmanagement, botremodeling en veilige loophervatting',color:'#0ea5e9',icon:'🦴',
  phases:[
    {label:'Fase 1',title:'Diagnose & Relatieve Rust',weeks:'Week 1–3',
     evidence:'<strong>MTSS — het mechanisme in dit protocol klopte niet.</strong> De kritische review stelt letterlijk dat histologisch onderzoek <strong>géén bewijs levert</strong> dat MTSS door periostitis als gevolg van tractie ontstaat; de oorzaak is <strong>botresorptie die de botaanmaak van de tibiale cortex overtreft</strong> (Moen et al., 2009 — Sports Med). <em>De eerdere beschrijving van periostale tractie door soleus en FDL is daarmee achterhaald en aangepast.</em> Diagnose berust op <strong>lichamelijk onderzoek</strong>; bijkomende beeldvorming met bot-, CT- of MRI-scan is goed onderzocht maar volgens dezelfde review van <strong>beperkte waarde</strong>, mede omdat afwijkingen ook bij klachtenvrije personen voorkomen. <em>De claim dat MRI de gouden standaard voor classificatie is en de bijhorende gradaties (Bhatt et al., 2020) zijn in dit dossier niet opgehaald en staan haaks op Moen.</em> <strong>Incidentie</strong> 4 tot 35% bij militairen en sporters — <em>het eerder vermelde bereik van 13 tot 20% bij lopers staat niet in de opgehaalde bron.</em> <strong>Risicofactoren</strong> uit meerdere prospectieve studies: overmatige pronatie bij staan en <strong>vrouwelijk geslacht</strong>; een voorgeschiedenis van MTSS is een extrinsieke risicofactor. Differentiaaldiagnose met chronisch compartimentsyndroom, tibiale stressfractuur en DVT blijft <em>klinische richtlijn.</em> <strong>Alternatief sporten</strong> (Winters et al., 2013): <em>in dit dossier niet opgehaald.</em>',
     goals:['Diagnose bevestigen (klinisch + MRI overwegen bij vermoeden van stressfractuur; de gradatie 1–4 is in dit dossier niet onderbouwd en Moen et al. (2009) noemt beeldvorming van beperkte waarde)','Provocerende loopactiviteit stoppen of drastisch verminderen','Alternatieve cardio starten (zwemmen/fietsen/pool running)','Pijn in rust 0/10','Risicofactoren identificeren (schoenwerk, loopvolume, voedingsdeficiëntie)'],
     exercises:[
       ...
       {name:'Kuitversterking (zittend, soleus)',cat:'kracht',params:[['Reps','15–20'],['Sets','3'],['Belasting','licht'],['Freq','3×/week']],note:'Knie 90° gebogen isoleert soleus. Kuitkracht ondersteunt de belastbaarheid; de tractie-oorzaak via de soleus-aanhechting wordt door Moen et al. (2009) juist verworpen. Kracht opbouwen zonder loopbelasting.'},
       {name:'Voedingsscreening',cat:'manueel',params:[['Aandacht','Vitamine D, Calcium, Energiebeschikbaarheid']],note:'Lage energiebeschikbaarheid (Relative Energy Deficiency in Sport — RED-S) verdient aandacht, zeker bij vrouwen; vrouwelijk geslacht is in meerdere prospectieve studies een risicofactor voor MTSS (Moen et al., 2009). De streefwaarden Vitamine D ≥ 75 nmol/L en calcium 1000–1300 mg/dag zijn in dit dossier niet onderbouwd — verwijs voor voedingsadvies naar arts of diëtist.'},
     ],
     criteria_go:['Pijn bij wandelen 0/10','Hop test (enkel been) pijnvrij','Drukpijn tibia ≤ 2/10','MRI-graad ≤ 2 (gradatie in dit dossier niet onderbouwd) óf 3 weken rust MRI-grade ≤ 3 (gradatie in dit dossier niet onderbouwd)'],
     criteria_stop:['Focale tibiale pijn bij palpatie (1–2 cm) → stressfractuur uitsluiten via MRI','Graad 4 MRI (gradatie niet onderbouwd) → volledige rust 8–12 wkn + orthopedisch consult'],
     redflags:['Tuningvork-test positief → stressfractuur tibia → MRI verplicht, geen loopactiviteit','Nachtpijn rustend aan tibia → botmetastase of osteoid osteoom uitsluiten','Compartimentdruk > 30 mmHg (afkapwaarde niet onderbouwd in dit dossier) na inspanning → chronisch compartimentsyndroom → chirurgisch consult','Roodheid + warmte + koorts → osteomyelitis uitsluitendiagnose']},
    {label:'Fase 2',title:'Krachtopbouw & Loopvoorbereiding',weeks:'Week 3–8',
     evidence:'<strong>Belastbaarheid opbouwen</strong> is het kernprincipe. <em>Maar let op wat de literatuur hier zegt: in drie gerandomiseerde studies was RUST gelijkwaardig aan élke onderzochte interventie (Moen et al., 2009). Dat betekent niet dat oefentherapie zinloos is, wel dat superioriteit ervan bij MTSS niet is aangetoond — en dat hoort de patiënt te weten.</em> Wat volgens diezelfde review wél preventief kan werken, zijn <strong>neopreen of semi-rigide orthesen</strong> (twee grote prospectieve studies). <strong>Kuitkracht</strong> (Meardon et al., 2014) en <strong>schoeisel</strong> (Tenforde et al., 2013): <em>beide in dit dossier niet opgehaald.</em> <strong>Cadans:</strong> <em>de aangehaalde studie (Wille et al., 2014 — JOSPT) onderzocht géén cadansinterventie en mat géén tibiale belasting; het is een laboratoriumstudie bij 45 lopers die nagaat of kinetiek uit sagittale kinematica te SCHATTEN valt — waarbij net de verticale belastingssnelheid zich slecht liet schatten (R² = 0,04). Cadansverhoging blijft klinische redenering.</em> <strong>Voetsterkte</strong>: <em>klinische redenering.</em>',
     ...
     exercises:[
       ...
       {name:'Looptechniekevaluatie',cat:'manueel',params:[['Cadans','meten (stappen/min)'],['Target','170–180 stappen/min (praktijkafspraak, niet onderbouwd)'],['Methode','metronoom-app']],note:'Cadans verhogen met 5–10% wordt klinisch toegepast om de belasting per stap te verlagen; de eerder vermelde reductie van 20–30% heeft geen bron en Wille et al. (2014) onderzocht geen cadansinterventie. Video-analyse footstrike: van hielstrike naar midfoot. Niet overhaast — geleidelijke aanpassing.'},
    ...
    {label:'Fase 3',title:'Graded Loophervatting',weeks:'Week 6–14',
     evidence:'<strong>Geleidelijke opbouw</strong> is klinisch verdedigbaar, <em>maar de aangehaalde bron onderbouwt de 10%-regel niet — ze concludeert het tegendeel: de resultaten over volume, duur, intensiteit en frequentie waren tegenstrijdig, en het was NIET mogelijk vast te stellen welke trainingsfouten met loopblessures samenhangen (Nielsen et al., 2012). De regel van 10% per week is dus een praktijkafspraak, geen bevinding.</em> <strong>Walk-run</strong> met loopintervallen van 1 minuut: <em>klinische richtlijn.</em> <strong>Botremodellering</strong> van 3 tot 6 maanden en het onderscheid tussen symptoomvrij en structureel hersteld: <em>klinisch breed gedragen, in dit dossier niet nagekeken.</em> <strong>Tijdcriteria</strong> van 6 tot 8 en 10 tot 16 weken steunen op de MRI-gradatie die volgens Moen et al. (2009) van beperkte waarde is: <em>praktijkafspraak.</em> <strong>Ondergrond:</strong> <em>dat asfalt 10 tot 15 maal hogere grondreactiekrachten geeft dan zacht terrein, is niet nagekeken en klinkt bovendien onwaarschijnlijk groot; het cijfer is geschrapt.</em>',
     ...
     exercises:[
       ...
       {name:'Progressief joggen (continu)',cat:'cardio',params:[['Opbouw','10 min → 15 → 20 → 30 min'],['Freq','3×/week'],['Ondergrond','gras/track → asfalt later']],note:'Na geslaagd walk-run: overstap naar continu joggen. 10%-regel (praktijkafspraak; Nielsen et al. 2012 kon geen trainingsfout aan blessures koppelen). Snelheid secundair aan volume. Schoeisel check elke 600–800 km (praktijkafspraak, niet onderbouwd).'},
    ...
    {label:'Fase 4',title:'Volledig Sporthervatting & Preventie',weeks:'Week 10–20+',
     evidence:'<strong>Recidiefrisico:</strong> een voorgeschiedenis van MTSS is in de review van Moen et al. (2009) een bevestigde risicofactor. <em>Tenforde et al. (2016) is in dit dossier niet opgehaald.</em> <strong>Preventie:</strong> de 10%-regel, calciuminname, schoeisel en krachtonderhoud zijn <em>praktijkafspraken; alleen neopreen of semi-rigide orthesen hebben in twee grote prospectieve studies preventieve waarde getoond (Moen et al., 2009).</em> <strong>Vrouwelijk geslacht</strong> is in meerdere prospectieve studies een intrinsieke risicofactor (Moen et al., 2009); screening op relatief energietekort (RED-S) blijft klinisch zinvol, <em>maar De Souza et al. (2014) is hier niet opgehaald.</em> <em>Dat lopers boven 60 km per week zonder afbouwweek een viermaal hogere incidentie hebben en dat schoenen na 600 tot 800 km vervangen moeten worden, is in dit dossier niet nagekeken.</em>',
     ...
     exercises:[
       {name:'Volledige looptraining (sport-specifiek)',cat:'cardio',params:[['Volume','opbouw naar pre-blessure niveau'],['Afbouwweken','elke 4e week volume −30%'],['Oppervlak','variatie gras/track/weg']],note:'10%-regel — praktijkafspraak, niet onderbouwd — blijft het uitgangspunt ook in RTS-fase. Elke 4 weken een rustigere week. Niet in een keer het volledige volume hervatten.'},
       {name:'Nordic Shin (tibialis anterior)',cat:'kracht',params:[['Reps','10–15'],['Sets','3'],['Freq','2×/week']],note:'Knielen op kniepad, enkels gefixeerd. Achterover kantelen met gestrekte romp. Eccentrische tibialis anterior. Een preventief effect bij lopers is niet aangetoond; de analogie met de Nordic Hamstring betreft een andere spiergroep en een andere pathologie.'},
       ...
       {name:'Loopjournaal bijhouden',cat:'manueel',params:[['Bijhouden','km, pijn, schoeisel, ondergrond'],['Alarm','bij pijn > 2/10 → 2 rustdagen']],note:'Data-gestuurde progressie. Lopers die een loopjournaal bijhouden hebben minder overbelastingsblessures — <em>het eerder vermelde cijfer van 40% had geen bron en is geschrapt</em> (trainervaring + data).'},
     ],
  ...
  refs:'Moen MH et al. (2009) — Medial tibial stress syndrome: a critical review. Sports Med 39(7):523-46; GEEN periostitis door tractie maar botresorptie die de aanmaak overtreft; rust gelijkwaardig aan elke interventie in drie RCT&#39;s. | Nielsen RO et al. (2012) — Training errors and running related injuries: a systematic review. Int J Sports Phys Ther 7(1):58-75; tegenstrijdige resultaten, GEEN trainingsfout kon aan blessures gekoppeld worden. | Wille CM et al. (2014) — <strong>Ability of sagittal kinematic variables to estimate ground reaction forces and joint kinetics in running</strong>. J Orthop Sports Phys Ther 44(10):825-30; geen cadansinterventie, geen tibiale belasting. | Winters M et al. (2013), Bhatt R et al. (2020), Tenforde AS et al. (2013 en 2016), Meardon SA et al. (2014) en De Souza MJ et al. (2014) — in dit dossier niet opgehaald.'};
  ...
  phases:[
    ...
    },
    {
      ...
      exercises:[
        ...
        {name:'Continu hardlopen (progressief)',params:[['Duur','20 → 45 min'],['Intensiteit','70 → 90%'],['Freq','3–4×/week'],['Progressie','10% /week']],note:'Volledige loophervatting met progressieve intensiteit. Varieer ondergrond. Monitor kniepijn 24u na training. 10%-regel (praktijkafspraak; Nielsen et al. 2012 kon geen trainingsfout aan blessures koppelen) handhaven om recidief te vermijden.',cat:'cardio'},
  ...
  phases:[
    ...
    },
    {
      ...
      goals:[
        ...
        'Trainingsbelastingsmonitoring implementeren (10%-regel (praktijkafspraak; Nielsen et al. 2012 kon geen trainingsfout aan blessures koppelen))',
...
const NAV_INFO = {
  ...
  disc:{naam:'Discectomie L4-L5', badge:'DISC', duur:'0–20+ wkn'},
  ...
  at: {
    ...
    stappen: [
      ...
      },
      {
        ...
        info: 'Alfredson Een excentrisch protocol voor PTTD komt in Kulig et al. (2004) niet voor; dosering is praktijkafspraak. HSR minstens gelijkwaardig met betere compliance (Beyer 2015).',
        opties: [
  ...
  dq: {
    ...
    stappen: [
      ...
      },
      {
        ...
        info: 'Peters-Veluthamaningal 2009 — in dit dossier niet opgehaald (Cochrane): 83% succespercentage injectie + spalk bij standaard eerste compartiment. Cavaleri 2016: combinatie superieur aan elk afzonderlijk. Evalueer na 6 weken.',
        opties: [
      ...
      },
      {
        ...
        info: 'Chern 2014 — in dit dossier niet opgehaald: patiënten met EPB-subcompartiment hebben significant lager conservatief succespercentage (38% vs 83%). Echogeleide injectie specifiek in beide subcompartementen verhoogt succeskans.',
        opties: [
      ...
      },
      {
        ...
        info: 'Peters-Veluthamaningal 2009 — in dit dossier niet opgehaald: NNT = 3 voor significante pijnreductie. Triamcinolon 40 mg of methylprednisolon 40 mg in 1 ml lidocaïne 1%. Maximum 2 injecties — daarna chirurgische indicatie. Injectie blind 64% accurate plaatsing — echo-geleiding verhoogt naar 97%.',
        opties: [
  ...
  cts: {
    ...
    stappen: [
      ...
      },
      {
        ...
        info: 'Marshall 2007 — in dit dossier niet opgehaald (Cochrane): lokale injectie effectiever dan placebo op 4–8 weken. Methylprednisolon 40 mg of triamcinolon 20 mg in 1 ml lidocaïne 1%. Maximum 2 injecties per jaar. Bij zwangerschap: veilig.',
        opties: [
      ...
      },
      {
        ...
        opties: [
          {label: 'Endoscopische release (manuele beroepen, snelle RTW)', advies: 'Voorkeur bij: manuele beroepen, jongere actieve patiënten. RTW: 10–14 dagen lichte arbeid, 3–4 weken manueel. Post-OK: fase 2 protocol dag 1–3. Success rate 97% (Atroshi 2009 — in dit dossier niet opgehaald).', color: '#22c55e'},
...
const BESCHRIJVING = {
  ...
  enkel:{
    kenmerken:'<strong>Laterale enkelpijn</strong> na inversietrauma met zwelling, hematoom en functieverlies. <strong>Ottawa Ankle Rules</strong> bepalen de fractuurnoodzaak — <em>de sensitiviteit van 97% staat niet in Bachmann et al. (2003); die review poolt negatieve likelihood ratio&#39;s (0,08) en spreekt van bijna 100% met matige specificiteit</em>. Graad I: rekking ATFL, loopvaardig; Graad II: partieelscheuring ATFL ± CFL, instabiel lopen; Graad III: complete ruptuur ATFL + CFL ± PTFL, forse instabiliteit en gewrichtlaxiteit. <strong>Anterieure drawer-test</strong> (ATFL) en de talar tilt-test (CFL): <em>de cijfers 73% en 90% hebben geen bron en wijken bovendien af van de 0,71 en 0,33 die elders in dit protocol staan; geen van beide is nagekeken</em>. <strong>Chronische enkelinstabiliteit</strong> (CAI) ontwikkelt zich bij een <strong>groot percentage</strong> van de patiënten na herhaalde distorsies (Gribble et al., 2016) — <em>het eerder vermelde cijfer van 40% en de drempel van 12 maanden staan niet in die consensusverklaring en zijn geschrapt.</em>',
    oorzaken:'<strong>Plantairflexie + inversie</strong> bij landing of richtingsverandering overschrijdt de peessterkte van het ATFL (zwakste laterale ligament; <em>de rupturkracht van ~140 N is in dit dossier niet nagekeken</em>). Risicofactoren: <strong>voorgeschiedenis enkeldistorsie</strong> (<em>de factor 2,4 is in dit dossier niet nagekeken</em>), proprioceptief deficit, peroneale spierspanning en vermoeidheid. Cavusvoet vergroot de inversieneiging. <strong>Neuromusculaire reactietijd</strong> van de peroneale spieren komt vermoedelijk te laat om een inversietrauma actief af te remmen (Konradsen &amp; Ravn, 1990 — <em>in dit dossier niet opgehaald</em>). <em>De drempel van 62 ms is niet nagekeken en botst met de 70 ms die elders in dit protocol stond; beide zijn nu als niet-onderbouwd gemarkeerd.</em> Terreinoppervlak, schoeisel en vermoeidheid laat in de wedstrijd zijn additionele precipiterende factoren.'
  },
  ...
  disc:{
    kenmerken:'<strong>Toestand na discectomie op niveau L4-L5</strong>, uitgevoerd als open, micro- of percutaan endoscopische ingreep. De operatie verwijdert het hernierende discusmateriaal dat de zenuwwortel comprimeert; ze herstelt de discus niet. <strong>Welke wortel is aangedaan?</strong> Bij een paramediane herniatie op L4-L5 is dat doorgaans de <strong>L5-wortel</strong> — extensie van de grote teen, sensibiliteit over de voetrug, geen bijhorende reflex. Bij een ver-laterale herniatie op hetzelfde niveau de <strong>L4-wortel</strong> — quadriceps, kniepeesreflex, mediale onderbeen. <em>Anatomische kennis; in dit dossier niet tegen een bron gelegd.</em> <strong>Restklachten</strong> na de ingreep zijn gebruikelijk: pijn verdwijnt doorgaans sneller dan krachtverlies en gevoelsstoornissen. Leg de neurologische uitgangswaarde vast, zodat NIEUWE uitval te onderscheiden is van restuitval. <em>Belangrijk voor de verwachtingen: de revalidatieliteratuur is NIET niveau-specifiek — L4-L5 bepaalt welke wortel je opvolgt, niet welk oefenprogramma je geeft.</em>',
    oorzaken:'<strong>Waarom er geopereerd werd</strong>, bepaalt mee wat je mag verwachten. De gangbare indicatie is aanhoudende of invaliderende radiculaire pijn, of progressief neurologisch uitval — niet rugpijn op zich. <strong>Herherniatie</strong> is de belangrijkste specifieke complicatie. In een meta-analyse van percutane endoscopische discectomie bedroeg ze 3,6% in het totaal en <strong>2,7% op niveau L4-L5</strong>, tegenover 3,1% op L5-S1 en 5,4% hoger lumbaal; <strong>61,7% van de recidieven trad binnen zes maanden op</strong> (Yin et al., 2018 — Pain Physician). <em>Die cijfers gelden voor de ENDOSCOPISCHE techniek en komen grotendeels uit retrospectieve studies van matige kwaliteit.</em> Hogere leeftijd (≥ 50 jaar) en een BMI ≥ 25 gingen samen met meer recidief — een SAMENHANG, geen aangetoond oorzakelijk verband. Een <strong>groot annulusdefect</strong> verhoogde het risico op symptoomrecidief (odds ratio 2,5; 95% BI 1,3–4,5) en heroperatie (2,3; 1,5–3,7) (Miller et al., 2018 — Spine); dat gegeven staat soms in het operatieverslag en is voor de kinesitherapeut niet beïnvloedbaar, wel informatief.'
  },

  cts:{
    kenmerken:'<strong>Nachtelijke pijn en tintelingen</strong> in het verzorgingsgebied van de n. medianus (duim, wijs- en middelvinger, radiaal ringvinger), verlichting bij schudden van de hand ("flick sign" — <em>de sensitiviteit van 93% is in dit dossier niet nagekeken</em>). Klinisch: positieve <strong>Phalen-test</strong> (60 sec polsflexie → paresthesieën; sensitiviteit 68%, specificiteit 73%), positieve <strong>Tinel-test</strong> bij het carpale niveau. Bij progressie: atrofie van de thenar, persisterend gevoelsverlies en knijpkrachtverlies. EMG/NCS bevestigt geleidingsvertraging van de n. medianus (distale motorlatentie > 4,5 ms als diagnostisch criterium).',
    oorzaken:'<strong>Verhoogde druk in het carpaaltunnel</strong> (normaal < 30 mmHg; bij CTS > 30 mmHg (afkapwaarde niet onderbouwd in dit dossier), bij polsflexie > 90 mmHg) comprimeert de n. medianus met ischemie en demyelinisatie als gevolg. Idiopathisch bij vrouwen > 50 jaar door tenosynovitis van de flexorpezen. Systemische oorzaken: <strong>diabetes</strong> (25% CTS-prevalentie), <strong>hypothyreoïdie</strong>, zwangerschap (oedeem), reumatoïde artritis en amyloïdose. Beroepsrisico: repetitieve polsbewegingen, trillingswerktuigen, geforceerde grip. <strong>Anatomische predispositie</strong>: klein carpaaltunnel-volume, persistente a. mediana. Obesitas (BMI > 30) verhoogt het risico met factor 2,5 (Becker et al., 2002 — Ann Intern Med).'
  },

  hsi:{
    kenmerken:'<strong>Plotse, hevige posterieure dijbeenpijn</strong> bij sprint (typisch in de late swing-fase), met onmiddellijk functieverlies. Palpatiepijn proximaal bij de ischiale aanhechting (graad III) of in het spierlichaam zelf. <strong>BAMIC-classificatie</strong> (MRI-gebaseerd) staat hier naast de indeling op vezelpercentage die de fasen van dit protocol gebruiken — <em>dat zijn twee verschillende systemen. De BAMIC-drempels, de uitspraak dat de SLR met dorsaalflexie de meest gevoelige klinische test is en de vergelijking van echografie met MRI zijn in dit dossier geen van drie nagekeken.</em> Herstel duurt globaal: Graad I ≈ 1–2 weken; Graad II ≈ 3–8 weken; Graad III ≈ 8–16 weken tot terugkeer naar sport — <em>deze tijdvensters zijn klinische richtlijn zonder bron, en zijn nu gelijkgetrokken met de fasen van dit protocol, waar eerder drie onderling verschillende reeksen stonden.</em>',
    oorzaken:'<strong>Excentrische overbelasting</strong> in de late swing-fase van de sprint — de biceps femoris lange kop is het meest aangedane spiergedeelte (<em>het percentage van 81% staat niet in Ekstrand et al. (2011), dat bovendien in AJSM verscheen en niet in BJSM; niet nagekeken</em>). Risicofactoren: <strong>voorafgaande hamstringblessure</strong> (<em>de factor 2-3× is in dit dossier niet nagekeken; Ekstrand et al. (2011) meldt wel dat 16% van de spierletsels herletsels zijn en dat die langer uitschakelen</em>), asymmetrie links-rechts kracht (<em>de H/Q-drempel van 0,60 is in dit dossier niet onderbouwd</em>), verminderde lumbopelvische stabiliteit en vermoeidheid laat in de wedstrijd. Leeftijd (> 24 jaar — <em>in strijd met Ekstrand et al. (2011), dat de leeftijdstoename uitsluitend voor KUITletsels vond en voor hamstrings uitdrukkelijk niet</em>), overmatige trainingsbelasting (<em>de 10%-regel is een praktijkafspraak, in dit dossier niet nagekeken</em>), inadequate opwarming en lage Nordic Hamstring compliance zijn bijkomende risicofactoren. <strong>Type II spiervezeldominantie</strong> bij sprinters vergroot het excentrische overbelastingsrisico.'
  },

  elb:{
    kenmerken:'<strong>Laterale elleboogpijn</strong> bij grepen, handdruk en polsextensieactiviteiten, gelokaliseerd op de laterale epicondyl of net distaal ervan. <strong>Cozen-test</strong> (weerstand polsextensie met gestrekte elleboog — sensitiviteit 84% — <em>in dit dossier niet nagekeken</em>) en Mill-test (passieve polsflexie met gestrekte elleboog) reproduceren de klachten. Palpatiepijn ter hoogte van de ECRB-aanhechting. Karakteristiek: <strong>geen actief inflammatoir beeld</strong> maar pijnprovocatie bij functiebelasting. <em>De eerder vermelde PRTEE-drempel van 30 had geen bron en botste met de fasedoelen van dit protocol; ze is geschrapt.</em> Echografie toont hypo-echogeniciteit, calcinosen of laesies bij de ECRB-enthese — <em>het percentage van 30% is in dit dossier niet nagekeken.</em>',
    oorzaken:'<strong>Tendinopathie van de extensor carpi radialis brevis</strong> (ECRB) aan de laterale epicondyl door cumulatief microtrauma. Pathologisch wordt doorgaans <strong>degeneratieve angiofibroblastische hyperplasie</strong> beschreven in plaats van een inflammatoir beeld (Nirschl &amp; Pettrone, 1979 — <em>in dit dossier niet opgehaald</em>; Coombes et al. (2015) stellen dat de pathofysiologie onvoldoende begrepen is) met disorganisatie van collageen type III, neovascularisatie en nociceptorproliferatie. Risicofactoren: <strong>repetitieve polsextensie/supinatie</strong> (tennis backhand, computermuis, schroevendraaier), leeftijd 40–55 jaar, dominante arm. Niet-sporters vormen het merendeel van de gevallen — kantoorpersoneel, bouwvakkers, koks — <em>maar het percentage van 60% is in dit dossier niet nagekeken.</em> Cervicale radiculopathie C6 kan bijdragen via neurale sensitisatie van de laterale elleboogregio.'
  },

  mtss:{
    kenmerken:'<strong>Diffuse, mediaal-tibiale pijn</strong> over het distale 2/3 van de tibia bij belasting (lopen, springen). Drukpijn over ≥ 5 cm langs de mediale tibiarand — dat criterium staat ook in de kritische review van Moen et al. (2009) en onderscheidt MTSS van een stressfractuur met puntpijn. Pijn typisch erger bij begin training, verbetert na opwarmen en keert terug na cooling down. <strong>Diagnose berust op lichamelijk onderzoek.</strong> Bijkomende beeldvorming met bot-, CT- of MRI-scan is volgens diezelfde review goed onderzocht maar van <strong>beperkte waarde</strong>, mede omdat afwijkingen ook bij klachtenvrije personen voorkomen (Moen et al., 2009 — Sports Med). <em>De eerder vermelde gradatie I–IV op botscan of MRI en de sensitiviteit van 75% voor de stemvorktest zijn in dit dossier niet nagekeken.</em>',
    oorzaken:'<strong>Botresorptie die de botaanmaak van de tibiale cortex overtreft</strong> is volgens de kritische review de oorzaak van MTSS. Diezelfde review stelt uitdrukkelijk dat histologisch onderzoek <strong>géén bewijs</strong> levert dat MTSS ontstaat door periostitis als gevolg van tractie (Moen et al., 2009 — Sports Med). <em>De eerdere beschrijving — periostale trekstress door tibialis posterior, flexor digitorum longus en soleus — is precies het model dat die bron verwerpt, en is geschrapt.</em> <strong>Risicofactoren</strong> die in meerdere prospectieve studies bevestigd zijn: <strong>overmatige pronatie bij staan</strong> en <strong>vrouwelijk geslacht</strong>; in enkele studies ook een hogere BMI, grotere in- en uitwendige heuprotatie en kuitomtrek. Een <strong>voorgeschiedenis van MTSS</strong> is een extrinsieke risicofactor. <em>Harde loopondergrond, schokabsorptie van schoeisel, lage botdensiteit en calcium- of vitamine D-inname staan niet in die review. Een volumestijging boven 10% per week evenmin — Nielsen et al. (2012) besluit juist dat geen enkele trainingsfout aan loopblessures gekoppeld kon worden. De incidentie van 10–20% bij militaire rekruten (Yates &amp; White, 2004) is in dit dossier niet opgehaald; Moen geeft 4 tot 35% bij militairen en sporters.</em>',
  },
  ...
  phases:[
    {
      ...
      evidence:'<strong>Ontlasting van het bicepsanker</strong> is in deze fase bepalend: de lange bicepspees hecht aan op het superieure labrum, waardoor weerstandsflexie van de elleboog en supinatie het letsel rechtstreeks belasten. <strong>Anterosuperieur impingement</strong> ontstaat bij flexie-adductie-endorotatie, waarbij de diepe zijde van de subscapularis en de reflectiepulley tegen de anterosuperieure glenoidrand aanschuren (Gerber &amp; Sebesta, 2000 — JSES; <em>in dit dossier niet opgehaald</em>). Bij een geassocieerde <strong>pulley-laesie</strong> (SGHL/CHL) is de bicepspees onstabiel in de sulcus; Habermeyer et al. (2004 — JSES; <em>in dit dossier niet opgehaald</em>) beschrijven een samenhang van deze laesies met anterosuperieure labrumpathologie. <strong>Postoperatief</strong> (SLAP-herstel of tenodese) geldt een sling gedurende 3–4 weken, verschuiven alle fasen ongeveer 2 weken en blijft actieve elleboogflexie tegen weerstand tot week 8 verboden — <em>deze tijdslijn is een praktijkafspraak, in dit dossier niet tegen een bron gelegd.</em>'
    },
    {
      label:'Fase 2',
      ...
      exercises:[
        ...
        {name:'Serratus anterior wall slide',params:[['Reps','12'],['Sets','3'],['Freq','1×/dag']],note:'Protractie aan het einde van de beweging. Serratuszwakte is een in dit dossier niet nagekeken als primaire oorzaak van scapulaire dyskinesie.',cat:'stabiliteit'},
        ...
        {name:'Exorotatie met elastiek in 0° abductie',params:[['Reps','15'],['Sets','3'],['Freq','5×/week']],note:'Handdoekrol in de oksel zou de supraspinatus- en infraspinatusactivatie verhogen — in dit dossier niet nagekeken — en beperkt compensatie.',cat:'kracht'},
      ...
      criteria_go:[
        ...
        'GIRD < 20° en totale rotatiebeweging binnen 10° van contralateraal (20° is de DEFINITIE van GIRD, geen aangetoonde behandeldrempel; de 10° is nergens onderbouwd en fase 4 hanteert 5°)',
      ...
      evidence:'<strong>Scapulaire revalidatie vóór krachtopbouw:</strong> Cools et al. (2014 — BJSM) presenteren daarvoor een <strong>klinisch redeneerkader</strong> waarbij bewuste scapulaire controle voorafgaat aan belaste oefeningen. <em>Het is een richtinggevende review, geen effectstudie; de auteurs stellen zelf vast dat overkoepelende revalidatierichtlijnen ontbreken.</em> <strong>GIRD — let op de significantie.</strong> In de aangehaalde reeks van 170 werperseizoenen bij profwerpers hadden werpers met GIRD (n = 40) <strong>bijna tweemaal</strong> zoveel kans op blessure, <strong>maar dat verschil was niet statistisch significant (p = 0,17)</strong>; over het totale rotatiedeficit staat enkel dat werpers met meer dan 5° deficit een hoger blessurecijfer hadden (Wilk et al., 2011 — AJSM, case series, bewijsniveau 4). <em>De eerder vermelde factor 2,5 staat er niet in, en de niet-significantie van de GIRD-bevinding ontbrak — GIRD blijft een verdedigbaar behandeldoel, maar als klinische redenering, niet als aangetoonde risicofactor.</em> <strong>Posterieure kapselstijfheid</strong> en de verschuiving van het rotatiecentrum: <em>mechanistische redenering, in dit dossier niet nagekeken.</em>',
    },
    {
      label:'Fase 3',
      ...
      weeks:'Week 6–12',
      goals:[
        'ER/IR-krachtratio ≥ 0,66 herstellen (praktijkafspraak — die waarde staat in geen enkele bron van dit protocol)',
      ...
      criteria_go:[
        'ER/IR-krachtratio ≥ 0,66 (handheld dynamometrie) — praktijkafspraak, niet uit Cools 2014',
      ...
      evidence:'<em>De ER/IR-verhouding van 0,66 staat niet in Cools et al. (2014); dat is een redeneerkader zonder die afkapwaarde. Het is de derde plaats in dit dossier waar 0,66 aan een bron wordt toegeschreven die ze niet bevat. De verhouding blijft bruikbaar als praktijkafspraak.</em> <strong>Gesloten-ketenoefeningen</strong> en de gefaseerde herintroductie van bicepsbelasting zijn <em>klinische redenering vanuit de anatomie van het bicepsanker.</em> <strong>Uitkomst van SLAP-herstel — belangrijk voor het gesprek met de patiënt.</strong> In een prospectief ingesloten reeks voldeed <strong>36,8%</strong> (66 van 179) aan de faalcriteria en koos <strong>28%</strong> voor een heringreep; leeftijd boven 36 jaar was de enige significante voorspeller van falen (relatief risico 3,45; 95% BI 2,0–4,9). <em>Weggelaten en klinisch relevant: de postoperatieve bewegingsuitslag was KLEINER dan preoperatief (flexie 159 tegenover 164°, abductie 151 tegenover 166°, exorotatie 51 tegenover 56°). De auteurs bevelen géén tenodese bij ouderen aan — ze besluiten dat verder onderzoek nodig is naar de optimale indicatiestelling</em> (Provencher et al., 2013 — AJSM).',
    },
    {
      label:'Fase 4',
    ...
    },
    {
      ...
      exercises:[
        ...
        {name:'Onderhoudsprogramma cuff en scapula',params:[['Reps','15'],['Sets','2–3'],['Freq','2×/week']],note:'Levenslang aanhouden bij overhead sporters. Dat therapietrouw de sterkste voorspeller van recidiefpreventie zou zijn, is in dit dossier niet nagekeken.',cat:'kracht'},
        {name:'Sleeper stretch onderhoud',params:[['Hold','30 sec'],['Reps','3'],['Freq','dagelijks']],note:'Onderhoud is klinisch aangewezen, zeker in het competitieseizoen; dat GIRD binnen enkele weken terugkeert zonder onderhoud is in dit dossier niet nagekeken.',cat:'mobiliteit'},
        {name:'Belastingsmonitoring sRPE',params:[['Freq','elke sessie'],['Doel','ACWR 0,8–1,3']],note:'Sessie-RPE × duur. De gehanteerde belastingsverhouding is een praktijkafspraak; een drempel van 1,5 is in dit dossier niet onderbouwd. Bedoeld om de belastingsopbouw te bewaken.',cat:'test'},
      ...
      criteria_go:[
        ...
        'ER/IR-ratio ≥ 0,66 met exorotatiekracht ≥ 95% van contralateraal — beide praktijkafspraken, niet onderbouwd',
        'Volledig interval programma pijnvrij doorlopen',
        'GIRD < 20° en verschil in totale rotatiebeweging < 5° (praktijkafspraken; Wilk 2011 noemt enkel dat > 5° deficit samenging met meer blessures)',
      ...
      evidence:'<strong>Conservatief beleid — met de juiste cijfers.</strong> De aangehaalde studie is een postenquête met een <strong>responsgraad van 16,4%</strong> waarin uiteindelijk <strong>slechts 19 patiënten</strong> niet-operatief behandeld waren; 51% van de bevraagde groep werd als falen beschouwd en geopereerd (Edwards et al., 2010 — AJSM, case series, bewijsniveau 4). Bij wie conservatief slaagde, verbeterden pijn, functie en levenskwaliteit significant (VAS 4,5 naar 2,1). <strong>Het cijfer dat voor dit protocol telt:</strong> 71% van <em>alle</em> sporters keerde terug naar het vorige niveau, maar <strong>slechts 66% van de bovenhandse sporters</strong> — en dit protocol gaat juist over bovenhandse sporters. <em>De auteurs besluiten dat bij bovenhandse atleten en bij uitblijvend resultaat chirurgie overwogen moet worden.</em> Een niet-operatieve proefperiode blijft verantwoord bij niet-mechanische klachten, <em>maar de bewijskracht is laag.</em> <strong>Criteriumgestuurde terugkeer</strong> en <strong>onderhoud</strong> zijn <em>klinische richtlijn; dat GIRD en scapulaire dyskinesie binnen weken terugkeren zonder training is niet nagekeken.</em>',
    }
  ],
  scores:[],
  refs:'Gerber C &amp; Sebesta A (2000). Impingement of the deep surface of the subscapularis tendon and the reflection pulley on the anterosuperior glenoid rim. J Shoulder Elbow Surg 9(6):483-90 | Habermeyer P et al. (2004). Anterosuperior impingement of the shoulder as a result of pulley lesions: a prospective arthroscopic study. J Shoulder Elbow Surg 13(1):5-12 | Rao AG et al. (2003). Anatomical variants in the anterosuperior aspect of the glenoid labrum. J Bone Joint Surg Am 85(4):653-9 | Edwards SL et al. (2010). Nonoperative treatment of superior labrum anterior posterior tears. Am J Sports Med 38(7):1456-61 &mdash; responsgraad 16,4%, 19 conservatief behandelde patienten; 66% terugkeer bij BOVENHANDSE sporters | Wilk KE et al. (2011). Correlation of GIRD and total rotational motion to shoulder injuries in professional baseball pitchers. Am J Sports Med 39(2):329-35 &mdash; case series niveau 4; GIRD-verband NIET significant (p = 0,17), geen factor 2,5 | Cools AM et al. (2014). Rehabilitation of scapular dyskinesis. Br J Sports Med 48(8):692-7 &mdash; redeneerkader, GEEN ER/IR-afkapwaarde van 0,66 | Provencher MT et al. (2013). A prospective analysis of 179 type 2 SLAP repairs. Am J Sports Med 41(4):880-6 &mdash; 36,8% faalt, 28% heringreep, postoperatieve ROM kleiner dan preoperatief | Rao AG et al. (2003), Alberta FG et al. (2010) en Habermeyer P et al. (2004) &mdash; in dit dossier niet opgehaald',
  spiergroep:'Rotatorenmanchet'
};
...
MANUEEL.elb = {
  intro:'Bij laterale epicondylalgie heeft manuele therapie een <strong>duidelijker plaats dan bij de meeste tendinopathieën</strong>, vooral als pijnmodulerende opstap naar belaste oefeningen. Mobilization with movement wordt gebruikt om oefenen mogelijk te maken; <em>de onmiddellijke winst in pijnvrije grijpkracht is in dit dossier niet tegen een primaire bron gelegd.</em> <strong>Progressieve krachttraining blijft de kerninterventie</strong>; dat manuele technieken zónder oefenprogramma tot herval leiden, is <em>klinische redenering, geen aangetoond verband.</em>',
  technieken:[
...
MANUEEL.disc = {
  intro:'Na een discectomie is manuele therapie <strong>ondersteunend en terughoudend</strong>. Er is in dit dossier géén bron die manuele therapie na discectomie onderzoekt; de technieken hieronder zijn overgenomen uit de gangbare praktijk bij lumbale radiculaire klachten en staan hier als <strong>klinische richtlijn</strong>, niet als evidentie. Het verse operatiegebied verdient de eerste weken terughoudendheid: werk eromheen, niet erop. <em>Wat wél onderbouwd is: oefentherapie vanaf vier tot zes weken geeft op korte termijn minder pijn en betere functie, en begeleide programma&#39;s presteerden daarbij niet beter dan thuisprogramma&#39;s (Oosterhuis et al., 2014 — Cochrane). Manuele therapie hoort dus een opstap naar oefenen te zijn, geen doel op zich.</em>',
  technieken:[
    {naam:'Weke-delentechnieken paravertebraal en gluteaal', fase:'Fase 2–3', doel:'Tonusreductie van reflexmatig verkrampte erector spinae, quadratus lumborum en gluteus medius, zodat actief oefenen mogelijk wordt.', uitvoering:'Buiklig of zijlig, buiten het litteken en het verse operatiegebied. Langzame longitudinale en dwarse technieken op de paraspinale musculatuur en de gluteaalregio. Blijf ruim weg van de incisie zolang die niet volledig gesloten en reactieloos is.', dosering:'5–8 min per regio, 1–2×/week — praktijkafspraak', voorzorg:'Niet vóór volledige wondgenezing. Bij toenemende beenpijn tijdens of na de behandeling: stoppen en heroverwegen.'},
    {naam:'Neurodynamische glijtechniek (slider) n. ischiadicus', fase:'Fase 3', doel:'Herstel van de longitudinale glijbeweging van de zenuw bij restklachten, zonder de mechanosensitiviteit te prikkelen.', uitvoering:'Ruglig of zit. Combineer knie-extensie met cervicale extensie en omgekeerd, zodat de zenuw glijdt zonder netto rek. Lage dosering, glijden en niet spannen.', dosering:'2–3 × 8–10 glijbewegingen, dagelijks tot 3×/week — praktijkafspraak', voorzorg:'Het onderzoek naar neurale mobilisatie betreft NEK- en ARMpijn, niet de lumbale wortel na discectomie — overdracht is klinische redenering. Bij uitstralingstoename direct afbouwen.'},
    {naam:'Mobilisatie van de heup en thoracolumbale overgang', fase:'Fase 2–4', doel:'Verminderen van compensatoire belasting op het geopereerde segment via aangrenzende regio&#39;s.', uitvoering:'Mobilisatie van heupextensie en -rotatie in buik- of zijlig, en van de thoracolumbale overgang in zit. Het geopereerde segment zelf wordt niet gemobiliseerd.', dosering:'3 × 30–60 sec per richting, 1–2×/week — praktijkafspraak', voorzorg:'Regionale interdependentie is een redenering, geen aangetoond mechanisme bij deze populatie.'},
    {naam:'Littekenmobilisatie', fase:'Fase 2–3', doel:'Soepelheid van het litteken en vermindering van lokale overgevoeligheid.', uitvoering:'Vanaf een volledig gesloten, reactieloze wond — doorgaans na twee tot drie weken, maar volg de chirurg. Zachte cirkelvormige druk rond en later op het litteken, progressief in diepte.', dosering:'3–5 min, 1–2×/dag vanaf een gesloten wond — praktijkafspraak', voorzorg:'Nooit op een wond die nog lekt, rood of warm is. Dat littekenmobilisatie adhesies vermindert, is in dit dossier niet onderbouwd.'},
    {naam:'Ontspannings- en ademtechnieken', fase:'Fase 1–3', doel:'Doorbreken van beschermende rompspanning en bewegingsangst.', uitvoering:'Ruglig met opgetrokken knieën, rustige diafragmale ademhaling gecombineerd met bewuste ontspanning van de rompmusculatuur. Ook bruikbaar als opstap naar de eerste actieve oefeningen.', dosering:'5–10 min, dagelijks — praktijkafspraak', voorzorg:'Geen.'}
  ],
  evidentie:'<strong>Er is in dit dossier géén bron die manuele therapie ná een discectomie onderzoekt.</strong> De technieken hierboven komen uit de gangbare praktijk bij lumbale radiculaire klachten en staan hier als klinische richtlijn. <em>Wat wél geverifieerd is, gaat over oefentherapie:</em> programma&#39;s die vier tot zes weken na de operatie starten gaven tegenover geen behandeling minder pijn (SMD -0,90; 95% BI -1,55 tot -0,24) en betere functie (SMD -0,67; -1,22 tot -0,12) op korte termijn, maar <strong>géén verschil op lange termijn</strong> (SMD -0,22; -0,49 tot 0,04). Begeleide en thuisprogramma&#39;s verschilden daarbij <strong>niet significant</strong>. Programma&#39;s die onmiddellijk na de operatie startten waren niet effectiever dan hun controlebehandeling. Bewijskwaliteit laag tot zeer laag (Oosterhuis et al., 2014 — Cochrane, 22 RCT&#39;s, 2503 deelnemers). <em>Conclusie voor de praktijk: zet manuele therapie in als opstap naar oefenen, niet als zelfstandige behandeling, en reken haar geen effect toe dat niet is aangetoond.</em>',
  contraindicaties:[
    'Verse, niet-gesloten of reactieve wond → geen enkele techniek op of rond het operatiegebied',
    'Nieuwe of toenemende neurologische uitval → eerst chirurgconsult, geen manuele behandeling',
    'Blaas- of darmstoornissen of rijbroekanesthesie → cauda equina, SPOEDVERWIJZING',
    'Koorts, wondlekkage of toenemende roodheid → verdenking infectie of liquorlekkage, arts contacteren',
    'Manipulatie (hoge snelheid, lage amplitude) van het geopereerde segment → niet toepassen; er is geen bron in dit dossier die veiligheid of nut daarvan na discectomie ondersteunt',
    'Toenemende radiculaire pijn tijdens of na een techniek → behandeling staken en beleid heroverwegen'
  ]
};
