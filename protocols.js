  ...
  tka:{id:'tka',title:'Totale Knieprothese',subtitle:'TKA revalidatie inclusief prehabilitatie, ERAS-protocol en sporthervatting',color:'#a78bfa',
    phases:[
      ...
      {label:'Week 1–2',title:'Vroeg Postoperatief',weeks:'Week 1–2',
       evidence:'<strong>Ziekenhuisduur van 2 tot 3 dagen</strong> bij ERAS: <em>klinische praktijk, in dit dossier niet nagekeken.</em> <strong>Cryotherapie — let op de conclusie van de bron.</strong> In elf gerandomiseerde trials met 809 deelnemers werd bewijs van <strong>zeer lage kwaliteit</strong> gevonden voor minder bloedverlies en voor minder pijn <strong>na 48 uur</strong> (1,32 punten op tien) — maar niet na 24 of 72 uur, en beide effecten mogelijk niet klinisch relevant. De auteurs besluiten dat de mogelijke voordelen <strong>te klein kunnen zijn om het gebruik te rechtvaardigen</strong>, afgewogen tegen ongemak en kosten (Adie et al., 2012 — Cochrane). <em>De app schreef simpelweg dat cryotherapie de pijn reduceert.</em> <strong>CPM wordt niet aanbevolen:</strong> geen klinisch relevante effecten op flexie (2 graden), pijn, functie of levenskwaliteit in 24 studies met 1445 deelnemers. <em>Wel een nuance die ontbrak: CPM verlaagt mogelijk het risico op manipulatie onder narcose (7,2% naar 1,6%; risicoratio 0,3), al is dat bewijs van zeer lage kwaliteit</em> (Harvey et al., 2014 — Cochrane).',
